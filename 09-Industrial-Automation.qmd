...
ggplot(benefits, aes(x = reorder(Category, Impact), y = Impact, fill = Category)) +
  ...
  geom_text(aes(label = Benefit), hjust = -0.1, size = 3.5 * diagram_text_scale, fontface = "bold") +
  coord_flip() +
...
ggplot(auto_long, aes(x = Type, y = Value, fill = Metric)) +
  ...
  geom_text(aes(label = Value), position = position_dodge(width = 0.7),
            vjust = -0.5, size = 3 * diagram_text_scale) +
  scale_fill_manual(values = c("#3498db", "#27ae60", "#e74c3c"),
...
ggplot(pyramid_levels, aes(x = 0, y = y)) +
  ...
  geom_text(aes(x = -2.5, label = level), fontface = "bold", hjust = 1, size = 4 * diagram_text_scale) +
  geom_text(aes(label = name), fontface = "bold", size = 4.5 * diagram_text_scale, color = "white") +
  geom_text(aes(label = description, y = y - 0.25), size = 3 * diagram_text_scale, color = "white") +
  scale_fill_identity() +
  ...
  theme(
    ...
    plot.subtitle = element_text(hjust = 0.5, size = 11 * diagram_text_scale)
  )
```
...
ggplot() +
  ...
  annotate("rect", xmin = 3, xmax = 7, ymin = 1, ymax = 4,
           fill = "#34495e", color = "black", linewidth = 1.5) +
  annotate("text", x = 5, y = 3.5, label = "PLC",
           color = "white", fontface = "bold", size = 8 * diagram_text_scale) +
  annotate("text", x = 5, y = 2.8, label = "Programmable Logic Controller",
           color = "white", size = 3.5 * diagram_text_scale) +
  annotate("text", x = 5, y = 2.2, label = "• Scan Inputs\n• Execute Program\n• Update Outputs",
           color = "#3498db", size = 3 * diagram_text_scale, lineheight = 0.9) +

  # Inputs
  annotate("rect", xmin = 0.5, xmax = 2.5, ymin = 1.5, ymax = 3.5,
           fill = "#27ae60", color = "black") +
  annotate("text", x = 1.5, y = 3.2, label = "INPUTS",
           color = "white", fontface = "bold", size = 4 * diagram_text_scale) +
  annotate("text", x = 1.5, y = 2.5, label = "• Switches\n• Sensors\n• Push buttons\n• Encoders",
           color = "white", size = 2.8 * diagram_text_scale, lineheight = 0.9) +
  annotate("segment", x = 2.5, xend = 3, y = 2.5, yend = 2.5,
           arrow = arrow(length = unit(0.3, "cm")), linewidth = 1.5, color = "#27ae60") +
  ...
  annotate("segment", x = 7, xend = 7.5, y = 2.5, yend = 2.5,
           arrow = arrow(length = unit(0.3, "cm")), linewidth = 1.5, color = "#e74c3c") +

  # Programming
  annotate("rect", xmin = 4, xmax = 6, ymin = 4.5, ymax = 5.5,
           fill = "#9b59b6", color = "black") +
  annotate("text", x = 5, y = 5, label = "Programming\n(Ladder, FBD, ST)",
           color = "white", size = 3 * diagram_text_scale, lineheight = 0.9) +
  annotate("segment", x = 5, xend = 5, y = 4.5, yend = 4,
           arrow = arrow(length = unit(0.3, "cm")), linewidth = 1, color = "#9b59b6") +
...
ggplot() +
  ...
  annotate("segment", x = 3.3, xend = 3.5, y = 3.2, yend = 2.5,
           arrow = arrow(length = unit(0.3, "cm")), color = "#3498db", linewidth = 1.5) +
  ...
  annotate("segment", x = 0.7, xend = 0.5, y = 1.5, yend = 2.5,
           arrow = arrow(length = unit(0.3, "cm")), color = "#e74c3c", linewidth = 1.5) +
  annotate("segment", x = 2.5, xend = 1.5, y = 0.7, yend = 0.5,
           arrow = arrow(length = unit(0.3, "cm")), color = "#f39c12", linewidth = 1.5) +
  ...
  annotate("text", x = 2, y = 2, label = "SCAN\nCYCLE\n(~10-50ms)",
           fontface = "bold", size = 5.5 * diagram_text_scale, lineheight = 0.9) +

  # Time annotations — placed below each step box
  annotate("text", x = c(2, 4, 2, 0), y = c(3.55, 1.55, -0.45, 1.55),
           label = scan_steps$time, size = 4.5 * diagram_text_scale, color = "gray40") +
  ...
  theme(
    ...
    plot.subtitle = element_text(hjust = 0.5, size = 13 * diagram_text_scale)
  )
```
...
ggplot() +
  # Power rails
  annotate("segment", x = 0.5, xend = 0.5, y = 0.5, yend = 4.5, linewidth = 2, color = "brown") +
  annotate("segment", x = 9.5, xend = 9.5, y = 0.5, yend = 4.5, linewidth = 2, color = "brown") +
  annotate("text", x = 0.5, y = 4.8, label = "L1\n(Hot)", size = 3 * diagram_text_scale, fontface = "bold") +
  annotate("text", x = 9.5, y = 4.8, label = "L2\n(Neutral)", size = 3 * diagram_text_scale, fontface = "bold") +

  # Rung 1: Start/Stop circuit with seal-in
  annotate("segment", x = 0.5, xend = 1.5, y = 4, yend = 4, linewidth = 1) +
  # Stop button (NC)
  annotate("segment", x = 1.5, xend = 1.8, y = 4, yend = 4, linewidth = 1) +
  annotate("segment", x = 1.8, xend = 2.2, y = 4.15, yend = 3.85, linewidth = 1.5, color = "#e74c3c") +
  annotate("segment", x = 2.2, xend = 2.5, y = 4, yend = 4, linewidth = 1) +
  annotate("text", x = 2, y = 4.4, label = "STOP", size = 2.5 * diagram_text_scale) +
  # Start button (NO)
  annotate("segment", x = 2.5, xend = 3.5, y = 4, yend = 4, linewidth = 1) +
  annotate("segment", x = 3.5, xend = 3.8, y = 4, yend = 4, linewidth = 1) +
  annotate("segment", x = 3.8, xend = 4.2, y = 4.15, yend = 4.15, linewidth = 1.5, color = "#27ae60") +
  annotate("segment", x = 4.2, xend = 4.5, y = 4, yend = 4, linewidth = 1) +
  annotate("text", x = 4, y = 4.4, label = "START", size = 2.5 * diagram_text_scale) +
  # Branch for seal-in contact
  annotate("segment", x = 2.5, xend = 2.5, y = 4, yend = 3.3, linewidth = 1) +
  annotate("segment", x = 2.5, xend = 3.5, y = 3.3, yend = 3.3, linewidth = 1) +
  annotate("segment", x = 3.5, xend = 3.8, y = 3.3, yend = 3.3, linewidth = 1) +
  annotate("segment", x = 3.8, xend = 4.2, y = 3.45, yend = 3.15, linewidth = 1.5, color = "#3498db") +
  annotate("segment", x = 4.2, xend = 4.5, y = 3.3, yend = 3.3, linewidth = 1) +
  annotate("text", x = 4, y = 3.7, label = "MOTOR", size = 2.5 * diagram_text_scale) +
  annotate("segment", x = 4.5, xend = 4.5, y = 4, yend = 3.3, linewidth = 1) +
  # Continue to output
  annotate("segment", x = 4.5, xend = 8, y = 4, yend = 4, linewidth = 1) +
  # Output coil (Motor)
  annotate("point", x = 8.5, y = 4, size = 15, shape = 21, fill = "white", color = "#3498db", stroke = 2) +
  annotate("text", x = 8.5, y = 4, label = "M", size = 4 * diagram_text_scale, fontface = "bold", color = "#3498db") +
  annotate("text", x = 8.5, y = 4.4, label = "MOTOR", size = 2.5 * diagram_text_scale) +
  annotate("segment", x = 9, xend = 9.5, y = 4, yend = 4, linewidth = 1) +

  # Rung 2: Motor running indicator
  annotate("segment", x = 0.5, xend = 3.5, y = 2, yend = 2, linewidth = 1) +
  annotate("segment", x = 3.5, xend = 3.8, y = 2, yend = 2, linewidth = 1) +
  annotate("segment", x = 3.8, xend = 4.2, y = 2.15, yend = 1.85, linewidth = 1.5, color = "#3498db") +
  annotate("segment", x = 4.2, xend = 8, y = 2, yend = 2, linewidth = 1) +
  annotate("text", x = 4, y = 2.4, label = "MOTOR", size = 2.5 * diagram_text_scale) +
  annotate("point", x = 8.5, y = 2, size = 15, shape = 21, fill = "white", color = "#27ae60", stroke = 2) +
  annotate("text", x = 8.5, y = 2, label = "L", size = 4 * diagram_text_scale, fontface = "bold", color = "#27ae60") +
  annotate("text", x = 8.5, y = 2.4, label = "RUN LIGHT", size = 2.5 * diagram_text_scale) +
  annotate("segment", x = 9, xend = 9.5, y = 2, yend = 2, linewidth = 1) +

  # Rung labels
  annotate("text", x = 0.2, y = 4, label = "1", fontface = "bold", size = 4 * diagram_text_scale) +
  annotate("text", x = 0.2, y = 2, label = "2", fontface = "bold", size = 4 * diagram_text_scale) +

  # Legend
  annotate("rect", xmin = 0.5, xmax = 4, ymin = 0.3, ymax = 1.3, fill = "#f8f9fa", color = "gray") +
  annotate("text", x = 0.7, y = 1.1, label = "Legend:", hjust = 0, fontface = "bold", size = 3 * diagram_text_scale) +
  annotate("segment", x = 0.7, xend = 1.1, y = 0.8, yend = 0.5, linewidth = 1, color = "#27ae60") +
  annotate("text", x = 1.3, y = 0.65, label = "NO Contact", hjust = 0, size = 2.5 * diagram_text_scale) +
  annotate("segment", x = 2.2, xend = 2.6, y = 0.8, yend = 0.5, linewidth = 1, color = "#e74c3c") +
  annotate("segment", x = 2.2, xend = 2.6, y = 0.65, yend = 0.65, linewidth = 0.5, color = "#e74c3c") +
  annotate("text", x = 2.8, y = 0.65, label = "NC Contact", hjust = 0, size = 2.5 * diagram_text_scale) +
  ...
  theme_void() +
  theme(
    plot.title = element_text(face = "bold", size = 12 * diagram_text_scale, hjust = 0.5),
...
ggplot() +
  ...
  annotate("rect", xmin = 0.5, xmax = 4.5, ymin = 0.5, ymax = 4.5,
           fill = "#ebf5fb", color = "#3498db", linewidth = 1) +
  annotate("text", x = 2.5, y = 4.2, label = "PNP (Sourcing)",
           fontface = "bold", size = 5 * diagram_text_scale, color = "#3498db") +
  ...
  # +V connection
  annotate("segment", x = 2, xend = 2, y = 3.5, yend = 4, color = "red", linewidth = 1) +
  annotate("text", x = 2, y = 4.1, label = "+24V", size = 3 * diagram_text_scale, color = "red") +
  # 0V connection
  annotate("segment", x = 3, xend = 3, y = 2, yend = 1.5, color = "blue", linewidth = 1) +
  annotate("text", x = 3, y = 1.3, label = "0V", size = 3 * diagram_text_scale, color = "blue") +
  # Output to PLC (sources current)
  annotate("segment", x = 3.5, xend = 4.2, y = 2.75, yend = 2.75, color = "brown", linewidth = 1) +
  annotate("text", x = 4.3, y = 2.75, label = "→ PLC Input", hjust = 0, size = 3 * diagram_text_scale) +
  annotate("text", x = 2.5, y = 1, label = "Current flows FROM sensor\nPLC input sinks to 0V",
           size = 2.8 * diagram_text_scale, lineheight = 0.9) +

  # NPN (Sinking)
  annotate("rect", xmin = 5.5, xmax = 9.5, ymin = 0.5, ymax = 4.5,
           fill = "#eafaf1", color = "#27ae60", linewidth = 1) +
  annotate("text", x = 7.5, y = 4.2, label = "NPN (Sinking)",
           fontface = "bold", size = 5 * diagram_text_scale, color = "#27ae60") +
  ...
  # +V connection
  annotate("segment", x = 7, xend = 7, y = 3.5, yend = 4, color = "red", linewidth = 1) +
  annotate("text", x = 7, y = 4.1, label = "+24V", size = 3 * diagram_text_scale, color = "red") +
  # 0V connection
  annotate("segment", x = 8, xend = 8, y = 2, yend = 1.5, color = "blue", linewidth = 1) +
  annotate("text", x = 8, y = 1.3, label = "0V", size = 3 * diagram_text_scale, color = "blue") +
  # Output to PLC (sinks current)
  annotate("segment", x = 8.5, xend = 9.2, y = 2.75, yend = 2.75, color = "brown", linewidth = 1) +
  annotate("text", x = 9.3, y = 2.75, label = "→ PLC Input", hjust = 0, size = 3 * diagram_text_scale) +
...
ggplot() +
  ...
  annotate("text", x = 1.25, y = 2.75, label = "AC Input\n(60Hz Fixed)",
           color = "white", fontface = "bold", size = 3 * diagram_text_scale, lineheight = 0.9) +
  ...
  annotate("text", x = 3.25, y = 3.2, label = "Rectifier",
           fontface = "bold", size = 3.5 * diagram_text_scale, color = "white") +
  annotate("text", x = 3.25, y = 2.5, label = "AC → DC",
           size = 3 * diagram_text_scale, color = "white") +
  ...
  annotate("text", x = 5.05, y = 2.5, label = "Filter &\nCapacitors",
           size = 3 * diagram_text_scale, color = "white", lineheight = 0.9) +
  ...
  annotate("text", x = 5.5, y = 4.4, label = "Control: Speed Reference, Start/Stop",
           color = "white", size = 2.8 * diagram_text_scale) +
  ...
  annotate("text", x = 5, y = 1.3, label = "VFD",
           fontface = "bold", size = 6 * diagram_text_scale, color = "gray30") +
...
ggplot() +
  ...
  annotate("text", x = 1.25, y = 2.75, label = "Motion\nController",
           color = "white", fontface = "bold", size = 3.5 * diagram_text_scale, lineheight = 0.9) +

  # Servo Drive
  annotate("rect", xmin = 3, xmax = 5, ymin = 2, ymax = 3.5,
           fill = "#3498db", color = "black") +
  annotate("text", x = 4, y = 2.75, label = "Servo\nDrive",
           color = "white", fontface = "bold", size = 4 * diagram_text_scale, lineheight = 0.9) +

  # Servo Motor
  annotate("point", x = 7, y = 2.75, size = 22, shape = 21,
           fill = "#27ae60", color = "black", stroke = 1.5) +
  annotate("text", x = 7, y = 2.75, label = "SM",
           fontface = "bold", size = 5 * diagram_text_scale, color = "white") +
  annotate("text", x = 7, y = 2, label = "Servo Motor", size = 3 * diagram_text_scale) +

  # Encoder (feedback)
  annotate("rect", xmin = 8, xmax = 9, ymin = 2.3, ymax = 3.2,
           fill = "#e74c3c", color = "black") +
  annotate("text", x = 8.5, y = 2.75, label = "ENC",
           color = "white", fontface = "bold", size = 3 * diagram_text_scale) +

  # Load
  annotate("rect", xmin = 9.5, xmax = 10.5, ymin = 2.3, ymax = 3.2,
           fill = "#95a5a6", color = "black") +
  annotate("text", x = 10, y = 2.75, label = "Load",
           fontface = "bold", size = 3.5 * diagram_text_scale) +

  # Forward connections
  annotate("segment", x = 2, xend = 3, y = 2.75, yend = 2.75,
           arrow = arrow(length = unit(0.2, "cm")), linewidth = 1) +
  annotate("text", x = 2.5, y = 3, label = "Command", size = 2.5 * diagram_text_scale) +
  annotate("segment", x = 5, xend = 6.3, y = 2.75, yend = 2.75,
           arrow = arrow(length = unit(0.2, "cm")), linewidth = 1.2, color = "#e67e22") +
  annotate("text", x = 5.6, y = 3, label = "Power", size = 2.5 * diagram_text_scale, color = "#e67e22") +
  annotate("segment", x = 7.7, xend = 8, y = 2.75, yend = 2.75, linewidth = 1) +
  annotate("segment", x = 9, xend = 9.5, y = 2.75, yend = 2.75,
           arrow = arrow(length = unit(0.2, "cm")), linewidth = 1) +

  # Feedback loop
  annotate("segment", x = 8.5, xend = 8.5, y = 2.3, yend = 1.5, linewidth = 1, color = "#e74c3c") +
  annotate("segment", x = 8.5, xend = 4, y = 1.5, yend = 1.5, linewidth = 1, color = "#e74c3c") +
  annotate("segment", x = 4, xend = 4, y = 1.5, yend = 2,
           arrow = arrow(length = unit(0.2, "cm")), linewidth = 1, color = "#e74c3c") +
...
ggplot() +
  ...
  annotate("text", x = 5, y = 7.5, label = "Enterprise Network (IT): ERP, MES, Business Systems",
           color = "white", fontface = "bold", size = 3.5 * diagram_text_scale) +
  ...
  annotate("text", x = 2.25, y = 4.5, label = "PLC", color = "white", fontface = "bold", size = 4 * diagram_text_scale) +

  annotate("rect", xmin = 4, xmax = 6, ymin = 4, ymax = 5, fill = "#3498db", color = "black") +
  annotate("text", x = 5, y = 4.5, label = "HMI/SCADA", color = "white", fontface = "bold", size = 4 * diagram_text_scale) +
  ...
  annotate("text", x = 7.75, y = 4.5, label = "Robot\nController", color = "white",
           fontface = "bold", size = 3 * diagram_text_scale, lineheight = 0.9) +
  ...
  annotate("text", x = 1.7, y = 1.5, label = "VFD", color = "white", fontface = "bold", size = 3.5 * diagram_text_scale) +

  annotate("rect", xmin = 2.8, xmax = 3.8, ymin = 1, ymax = 2, fill = "#f39c12", color = "black") +
  annotate("text", x = 3.3, y = 1.5, label = "I/O", color = "white", fontface = "bold", size = 3.5 * diagram_text_scale) +

  annotate("rect", xmin = 4.4, xmax = 5.4, ymin = 1, ymax = 2, fill = "#f39c12", color = "black") +
  annotate("text", x = 4.9, y = 1.5, label = "Sensors", color = "white", fontface = "bold", size = 3 * diagram_text_scale) +
  ...
  annotate("segment", x = 5, xend = 5, y = 7, yend = 6.5, linewidth = 1) +
  annotate("segment", x = 2.25, xend = 2.25, y = 5.5, yend = 5, linewidth = 1) +
  annotate("segment", x = 5, xend = 5, y = 5.5, yend = 5, linewidth = 1) +
  annotate("segment", x = 7.75, xend = 7.75, y = 5.5, yend = 5, linewidth = 1) +
  annotate("segment", x = 2.25, xend = 2.25, y = 4, yend = 3.3, linewidth = 1) +

  # Device connections
  annotate("segment", x = 1.7, xend = 1.7, y = 2.5, yend = 2, linewidth = 0.8) +
  annotate("segment", x = 3.3, xend = 3.3, y = 2.5, yend = 2, linewidth = 0.8) +
  annotate("segment", x = 4.9, xend = 4.9, y = 2.5, yend = 2, linewidth = 0.8) +
  annotate("segment", x = 6.5, xend = 6.5, y = 2.5, yend = 2, linewidth = 0.8) +
  annotate("segment", x = 8.1, xend = 8.1, y = 2.5, yend = 2, linewidth = 0.8) +
...
kable(protocols, caption = "Common Industrial Communication Protocols") %>%
  kable_styling(bootstrap_options = c("striped", "hover"), full_width = knitr::is_html_output()) %>%
  column_spec(1, bold = TRUE, width = if (knitr::is_html_output()) "14%" else NULL) %>%
...
ggplot() +
  ...
  annotate("rect", xmin = 1, xmax = 9, ymin = 1, ymax = 7,
           fill = "#ecf0f1", color = "#2c3e50", linewidth = 2) +
  ...
  annotate("text", x = 1.7, y = 5.75, label = "Overview", color = "white", size = 2.5 * diagram_text_scale) +
  annotate("rect", xmin = 2.4, xmax = 3.4, ymin = 5.5, ymax = 6, fill = "#95a5a6") +
  annotate("text", x = 2.9, y = 5.75, label = "Alarms", color = "white", size = 2.5 * diagram_text_scale) +
  annotate("rect", xmin = 3.6, xmax = 4.6, ymin = 5.5, ymax = 6, fill = "#95a5a6") +
  annotate("text", x = 4.1, y = 5.75, label = "Trends", color = "white", size = 2.5 * diagram_text_scale) +
  annotate("rect", xmin = 4.8, xmax = 5.8, ymin = 5.5, ymax = 6, fill = "#95a5a6") +
  annotate("text", x = 5.3, y = 5.75, label = "Settings", color = "white", size = 2.5 * diagram_text_scale) +
  ...
  annotate("text", x = 2.25, y = 4.7, label = "TANK 1", fontface = "bold", size = 3 * diagram_text_scale) +
  annotate("text", x = 2.25, y = 3.4, label = "75%", color = "white", fontface = "bold", size = 4 * diagram_text_scale) +

  # Pump symbol
  annotate("point", x = 4, y = 3, size = 12, shape = 21, fill = "#27ae60", color = "black") +
  annotate("text", x = 4, y = 3, label = "P1", fontface = "bold", size = 3 * diagram_text_scale) +
  annotate("text", x = 4, y = 2.4, label = "RUNNING", color = "#27ae60", size = 2.5 * diagram_text_scale) +

  # Flow indicator
  annotate("rect", xmin = 5.2, xmax = 6.5, ymin = 2.7, ymax = 3.6, fill = "white", color = "black") +
  annotate("text", x = 5.85, y = 3.35, label = "FLOW", size = 2.5 * diagram_text_scale) +
  annotate("text", x = 5.85, y = 3, label = "125.5", fontface = "bold", size = 4 * diagram_text_scale, color = "#2c3e50") +
  annotate("text", x = 5.85, y = 2.75, label = "GPM", size = 2.5 * diagram_text_scale) +

  # Temperature indicator
  annotate("rect", xmin = 7, xmax = 8.3, ymin = 2.7, ymax = 3.6, fill = "white", color = "black") +
  annotate("text", x = 7.65, y = 3.35, label = "TEMP", size = 2.5 * diagram_text_scale) +
  annotate("text", x = 7.65, y = 3, label = "185.2", fontface = "bold", size = 4 * diagram_text_scale, color = "#e74c3c") +
  annotate("text", x = 7.65, y = 2.75, label = "°F", size = 2.5 * diagram_text_scale) +

  # Pipes
  annotate("segment", x = 3, xend = 3.5, y = 3, yend = 3, linewidth = 3, color = "#3498db") +
  annotate("segment", x = 4.5, xend = 5.2, y = 3, yend = 3, linewidth = 3, color = "#3498db") +
  annotate("segment", x = 6.5, xend = 7, y = 3.15, yend = 3.15, linewidth = 3, color = "#3498db") +

  # Status bar
  annotate("rect", xmin = 1, xmax = 9, ymin = 1, ymax = 1.8, fill = "#2c3e50") +
  annotate("text", x = 1.5, y = 1.4, label = "Status: AUTO", color = "#27ae60",
           hjust = 0, size = 3 * diagram_text_scale, fontface = "bold") +
  annotate("text", x = 4.5, y = 1.4, label = "Active Alarms: 0", color = "#27ae60",
           hjust = 0, size = 3 * diagram_text_scale) +
  annotate("text", x = 7.5, y = 1.4, label = "14:35:22", color = "white", size = 3 * diagram_text_scale) +

  # Control buttons
  annotate("rect", xmin = 7, xmax = 8.5, ymin = 4.5, ymax = 5.2, fill = "#27ae60", color = "black") +
  annotate("text", x = 7.75, y = 4.85, label = "START", color = "white", fontface = "bold", size = 3 * diagram_text_scale) +
  annotate("rect", xmin = 7, xmax = 8.5, ymin = 3.8, ymax = 4.4, fill = "#e74c3c", color = "black") +
  annotate("text", x = 7.75, y = 4.1, label = "STOP", color = "white", fontface = "bold", size = 3 * diagram_text_scale) +
...
ggplot() +
  # Safety PLC
  annotate("rect", xmin = 4, xmax = 6, ymin = 3, ymax = 5, fill = "#f1c40f", color = "black", linewidth = 1.5) +
  annotate("text", x = 5, y = 4.5, label = "SAFETY", fontface = "bold", size = 4 * diagram_text_scale) +
  annotate("text", x = 5, y = 4, label = "PLC", fontface = "bold", size = 4 * diagram_text_scale) +
  annotate("text", x = 5, y = 3.4, label = "(SIL 3 / PLe)", size = 3 * diagram_text_scale) +

  # Safety inputs
  annotate("rect", xmin = 0.5, xmax = 2.5, ymin = 4.5, ymax = 5.5, fill = "#e74c3c", color = "black") +
  annotate("text", x = 1.5, y = 5, label = "E-Stop", color = "white", fontface = "bold", size = 3.5 * diagram_text_scale) +

  annotate("rect", xmin = 0.5, xmax = 2.5, ymin = 3.3, ymax = 4.3, fill = "#e74c3c", color = "black") +
  annotate("text", x = 1.5, y = 3.8, label = "Light Curtain", color = "white", fontface = "bold", size = 3.5 * diagram_text_scale) +

  annotate("rect", xmin = 0.5, xmax = 2.5, ymin = 2.1, ymax = 3.1, fill = "#e74c3c", color = "black") +
  annotate("text", x = 1.5, y = 2.6, label = "Safety Gate", color = "white", fontface = "bold", size = 3.5 * diagram_text_scale) +

  annotate("rect", xmin = 0.5, xmax = 2.5, ymin = 0.9, ymax = 1.9, fill = "#e74c3c", color = "black") +
  annotate("text", x = 1.5, y = 1.4, label = "Two-Hand Ctrl", color = "white", fontface = "bold", size = 3.5 * diagram_text_scale) +
  ...
  # Connections
  annotate("segment", x = 2.5, xend = 4, y = 5, yend = 4.5, linewidth = 1,
           arrow = arrow(length = unit(0.2, "cm"))) +
  annotate("segment", x = 2.5, xend = 4, y = 3.8, yend = 4.2, linewidth = 1,
           arrow = arrow(length = unit(0.2, "cm"))) +
  annotate("segment", x = 2.5, xend = 4, y = 2.6, yend = 3.5, linewidth = 1,
           arrow = arrow(length = unit(0.2, "cm"))) +
  annotate("segment", x = 2.5, xend = 4, y = 1.4, yend = 3.3, linewidth = 1,
           arrow = arrow(length = unit(0.2, "cm"))) +

  annotate("segment", x = 6, xend = 7.5, y = 4.5, yend = 5, linewidth = 1,
           arrow = arrow(length = unit(0.2, "cm"))) +
  annotate("segment", x = 6, xend = 7.5, y = 4.2, yend = 3.8, linewidth = 1,
           arrow = arrow(length = unit(0.2, "cm"))) +
  annotate("segment", x = 6, xend = 7.5, y = 3.5, yend = 2.6, linewidth = 1,
           arrow = arrow(length = unit(0.2, "cm"))) +

  # Standard PLC communication
  annotate("rect", xmin = 4, xmax = 6, ymin = 0.5, ymax = 2, fill = "#3498db", color = "black") +
  annotate("text", x = 5, y = 1.5, label = "Standard", fontface = "bold", size = 3.5 * diagram_text_scale, color = "white") +
  annotate("text", x = 5, y = 1, label = "PLC", fontface = "bold", size = 3.5 * diagram_text_scale, color = "white") +
  annotate("segment", x = 5, xend = 5, y = 2, yend = 3, linewidth = 1, linetype = "dashed",
           arrow = arrow(length = unit(0.15, "cm"), ends = "both")) +
  annotate("text", x = 5.7, y = 2.5, label = "Status\nExchange", size = 2.5 * diagram_text_scale, lineheight = 0.9) +
...
ggplot(i4_tech, aes(x = x, y = y)) +
  ...
  geom_text(aes(label = Technology), fontface = "bold", size = 3.5 * diagram_text_scale, color = "white", vjust = -0.5) +
  geom_text(aes(label = Description), size = 2.8 * diagram_text_scale, color = "white", vjust = 1.5, lineheight = 0.9) +
...
vibration <- baseline_vibration +
  ...
  0.9 * exp((days - 25)/5) * (days > 20) +  # Accelerating failure
...
ggplot(vib_data, aes(x = Day, y = Vibration)) +
  ...
  annotate("text", x = (warning_day + alarm_day)/2, y = 7.5,
           label = "Maintenance\nWindow", fontface = "bold", size = 3 * diagram_text_scale) +
