...
ggplot(benefits, aes(x = reorder(Category, Impact), y = Impact, fill = Category)) +
  ...
  geom_text(aes(label = paste0(Benefit, "\n", Description)),
            hjust = 0, size = 3 * diagram_text_scale, lineheight = 0.9, nudge_y = 2) +
  coord_flip() +
  ...
  theme_minimal() +
  theme(
    plot.title = element_text(face = "bold", size = 14 * diagram_text_scale),
    axis.text.y = element_text(size = 11 * diagram_text_scale, face = "bold")
  )
```
...
kable(evolution, col.names = c("Era", "Approach", "Focus", "Key Figures/Standards"),
  ...
  column_spec(1, bold = TRUE, width = if (knitr::is_html_output()) "12%" else NULL) %>%
...
ggplot(principles, aes(x = x, y = y)) +
  ...
  geom_text(aes(label = number), color = "white", size = 10 * diagram_text_scale, fontface = "bold") +
  geom_text(aes(label = principle, y = y - 0.7), size = 5 * diagram_text_scale, fontface = "bold", lineheight = 0.9) +
  ...
  theme_void() +
  theme(
    plot.title = element_text(face = "bold", size = 16 * diagram_text_scale, hjust = 0.5),
...
ggplot(clauses, aes(x = 1, y = y)) +
  ...
  geom_text(aes(x = -0.3, label = clause), fontface = "bold", size = 7 * diagram_text_scale, color = "#2c3e50") +
  geom_text(aes(x = 0.3, label = title), fontface = "bold", size = 5.5 * diagram_text_scale, hjust = 0, color = "white") +
  geom_text(aes(x = 2.8, label = description), size = 4.8 * diagram_text_scale, hjust = 1, color = "white") +
...
ggplot() +
  ...
  annotate("text", x = 5, y = 8, label = "PLAN", color = "white",
           fontface = "bold", size = 7 * diagram_text_scale) +
  annotate("text", x = 5, y = 9.5, label = "Clause 4: Context\nClause 5: Leadership\nClause 6: Planning",
           size = 4.5 * diagram_text_scale, hjust = 0.5, lineheight = 0.9) +
  ...
  annotate("text", x = 9.8, y = 5, label = "Clause 7: Support\nClause 8: Operation",
           size = 4.5 * diagram_text_scale, hjust = 0, lineheight = 0.9) +

  # CHECK (bottom)
  annotate("point", x = 5, y = 2, size = 28, color = "#f39c12") +
  annotate("text", x = 5, y = 2, label = "CHECK", color = "white",
           fontface = "bold", size = 6 * diagram_text_scale) +
  ...
  annotate("text", x = 0.2, y = 5, label = "Clause 10:\nImprovement",
           size = 4.5 * diagram_text_scale, hjust = 1, lineheight = 0.9) +

  # Center label
  annotate("text", x = 5, y = 5, label = "QMS", fontface = "bold", size = 8 * diagram_text_scale) +
  ...
  theme_void() +
  theme(
    plot.title = element_text(face = "bold", size = 18 * diagram_text_scale, hjust = 0.5),
    plot.subtitle = element_text(size = 12 * diagram_text_scale, hjust = 0.5)
  )
```
...
kable(risk_table, caption = "Risk-Based Thinking in ISO 9001:2015") %>%
  kable_styling(bootstrap_options = c("striped", "hover"), full_width = knitr::is_html_output()) %>%
  column_spec(1, bold = TRUE, width = if (knitr::is_html_output()) "10%" else NULL) %>%
  column_spec(2, width = if (knitr::is_html_output()) "25%" else NULL)
```
...
ggplot(standards, aes(x = x, y = y)) +
  ...
  geom_text(aes(label = Standard), fontface = "bold", size = 4 * diagram_text_scale, color = "white", vjust = -1) +
  geom_text(aes(label = Industry), size = 5.5 * diagram_text_scale, color = "white") +
  geom_text(aes(label = Base), size = 4.8 * diagram_text_scale, color = "white", vjust = 2, lineheight = 0.9) +
...
kable(iatf_requirements, col.names = c("Requirement Area", "ISO 9001", "IATF 16949 Addition"),
  ...
  kable_styling(bootstrap_options = c("striped", "hover"), full_width = knitr::is_html_output()) %>%
  column_spec(1, bold = TRUE, width = if (knitr::is_html_output()) "18%" else NULL) %>%
...
ggplot(core_tools, aes(x = x, y = 1)) +
  ...
  geom_text(aes(label = tool), fontface = "bold", size = 8 * diagram_text_scale, color = "white", vjust = -1) +
  geom_text(aes(label = name), size = 6 * diagram_text_scale, color = "white", lineheight = 0.9) +
  geom_text(aes(label = purpose, y = 0.3), size = 5 * diagram_text_scale, color = "white", lineheight = 0.9) +
  ...
  theme(
    plot.title = element_text(face = "bold", size = 18 * diagram_text_scale, hjust = 0.5),
    plot.subtitle = element_text(hjust = 0.5, size = 12 * diagram_text_scale)
  )
```
...
ggplot(apqp_phases, aes(x = x, y = 1)) +
  ...
  geom_point(size = 22, color = "#3498db") +
  geom_text(aes(label = phase), color = "white", fontface = "bold", size = 10 * diagram_text_scale) +
  geom_text(aes(label = name, y = 2.2), fontface = "bold", size = 6 * diagram_text_scale, lineheight = 0.85) +
  geom_text(aes(label = activities, y = -0.2), size = 5 * diagram_text_scale, lineheight = 0.85, color = "gray30") +
  annotate("segment", x = 0.6, xend = 5.4, y = 1, yend = 1,
...
kable(ppap_elements, caption = "PPAP 18 Elements Required for Submission") %>%
  kable_styling(bootstrap_options = c("striped", "hover"), full_width = knitr::is_html_output()) %>%
  column_spec(1, bold = TRUE, width = if (knitr::is_html_output()) "30%" else NULL)
```
...
kable(fmea_example, caption = "Process FMEA Structure and Example") %>%
  kable_styling(bootstrap_options = c("striped", "hover"), full_width = knitr::is_html_output()) %>%
  column_spec(1, bold = TRUE, width = if (knitr::is_html_output()) "20%" else NULL) %>%
  column_spec(3, width = if (knitr::is_html_output()) "30%" else NULL)
```
...
ggplot(rpn_data, aes(x = x, y = 1)) +
  ...
  geom_text(aes(label = paste0("RPN: ", range)), fontface = "bold",
            color = "white", size = 6 * diagram_text_scale, vjust = -1) +
  geom_text(aes(label = priority), color = "white", size = 8 * diagram_text_scale, fontface = "bold") +
  geom_text(aes(label = action), color = "white", size = 5 * diagram_text_scale, vjust = 2) +
  coord_cartesian(ylim = c(0.2, 1.8)) +
  labs(title = "RPN-Based Action Priority") +
  theme_void() +
  theme(plot.title = element_text(face = "bold", size = 18 * diagram_text_scale, hjust = 0.5))
```
...
ggplot(msa_data, aes(x = x, y = y)) +
  ...
  geom_text(aes(label = component), color = "white", fontface = "bold", size = 7 * diagram_text_scale, vjust = -0.5) +
  geom_text(aes(label = definition), color = "white", size = 5 * diagram_text_scale, vjust = 1.2, lineheight = 0.85) +
...
ggplot(xbar_data, aes(x = subgroup, y = xbar)) +
  ...
  annotate("text", x = 31, y = ucl, label = paste0("UCL = ", round(ucl, 2)), hjust = 0, size = 5 * diagram_text_scale) +
  annotate("text", x = 31, y = lcl, label = paste0("LCL = ", round(lcl, 2)), hjust = 0, size = 5 * diagram_text_scale) +
  annotate("text", x = 31, y = cl, label = paste0("CL = ", cl), hjust = 0, size = 5 * diagram_text_scale) +
  ...
  theme_minimal() +
  theme(
    plot.title = element_text(face = "bold", size = 18 * diagram_text_scale),
    plot.subtitle = element_text(size = 12 * diagram_text_scale),
    axis.title = element_text(size = 12 * diagram_text_scale),
    axis.text = element_text(size = 11 * diagram_text_scale),
    legend.position = "bottom",
    legend.title = element_blank(),
    legend.text = element_text(size = 11 * diagram_text_scale)
  )
```
...
kable(as9100_req, caption = "AS9100D Key Additional Requirements") %>%
  kable_styling(bootstrap_options = c("striped", "hover"), full_width = knitr::is_html_output()) %>%
  column_spec(1, bold = TRUE, width = if (knitr::is_html_output()) "25%" else NULL)
```
...
ggplot() +
  ...
  annotate("text", x = 5, y = 6.2, label = "Level 1\nQuality Policy\n& Objectives",
           color = "white", fontface = "bold", size = 6 * diagram_text_scale, lineheight = 0.9) +
  ...
  annotate("text", x = 5, y = 4.3, label = "Level 2\nQuality Manual & Procedures\nWhat we do and who is responsible",
           color = "white", fontface = "bold", size = 5 * diagram_text_scale, lineheight = 0.9) +
  ...
  annotate("text", x = 5, y = 0.8, label = "Level 4: Records & Forms - Evidence that we did it",
           color = "white", fontface = "bold", size = 5 * diagram_text_scale) +

  # Examples on the right
  annotate("text", x = 9, y = 6.2, label = "• Quality Policy statement\n• Quality objectives",
           hjust = 0, size = 5 * diagram_text_scale, lineheight = 0.9) +
  ...
  annotate("text", x = 9, y = 0.8, label = "• Inspection records • Training records • Audit reports",
           hjust = 0, size = 5 * diagram_text_scale) +
...
ggplot(audit_steps, aes(x = x, y = 1)) +
  ...
  geom_text(aes(label = step), color = "white", fontface = "bold", size = 8 * diagram_text_scale) +
  geom_text(aes(label = name, y = 0.4), size = 5 * diagram_text_scale, fontface = "bold", angle = 45, hjust = 1) +
  geom_text(aes(label = description, y = 1.6), size = 5 * diagram_text_scale, lineheight = 0.9) +
...
ggplot(capa_steps, aes(x = x, y = y)) +
  ...
  geom_text(aes(label = paste0(step, ". ", name)), fontface = "bold",
            size = 5 * diagram_text_scale, color = "white", vjust = -0.5) +
  geom_text(aes(label = description), size = 5 * diagram_text_scale, color = "white",
...
kable(capa_sources, caption = "Common CAPA Initiation Sources") %>%
  kable_styling(bootstrap_options = c("striped", "hover"), full_width = knitr::is_html_output()) %>%
  column_spec(1, bold = TRUE, width = if (knitr::is_html_output()) "20%" else NULL) %>%
  column_spec(3, width = if (knitr::is_html_output()) "12%" else NULL)
```
...
ggplot(rca_tools, aes(x = x, y = 1)) +
  ...
  geom_text(aes(label = tool), color = "white", fontface = "bold", size = 6 * diagram_text_scale, vjust = -0.6, lineheight = 0.85) +
  geom_text(aes(label = best_for), color = "white", size = 5 * diagram_text_scale, vjust = 0.8, lineheight = 0.85) +
...
p1 <- ggplot(objectives, aes(x = x)) +
  ...
  geom_text(aes(y = 0, label = Objective), vjust = 1.5, size = 5 * diagram_text_scale, lineheight = 0.8) +
  labs(title = "Quality Objectives: Target vs Actual", x = "", y = "") +
  theme_minimal() +
  theme(axis.text.x = element_blank(), plot.title = element_text(face = "bold", size = 14 * diagram_text_scale))
...
p2 <- ggplot(satisfaction, aes(x = Quarter, y = Score, group = 1)) +
  ...
  annotate("text", x = 4.2, y = 4.0, label = "Target", color = "red", size = 5 * diagram_text_scale) +
  scale_y_continuous(limits = c(3.5, 5)) +
  labs(title = "Customer Satisfaction Trend", x = "", y = "Score (1-5)") +
  theme_minimal() +
  theme(plot.title = element_text(face = "bold", size = 14 * diagram_text_scale),
...
p3 <- ggplot(audit_data, aes(x = Type, y = Count, fill = Type)) +
  ...
  geom_text(aes(label = Count), vjust = -0.5, size = 6 * diagram_text_scale) +
...
p4 <- ggplot(capa_status, aes(x = "", y = Count, fill = Status)) +
  ...
  geom_text(aes(label = paste0(Count, "\n(", round(Count/sum(Count)*100), "%)")),
            position = position_stack(vjust = 0.5), color = "white", size = 3 * diagram_text_scale) +
  scale_fill_manual(values = c("#e74c3c", "#f39c12", "#3498db", "#27ae60")) +
  labs(title = "CAPA Status Distribution", fill = "") +
  theme_void() +
  theme(plot.title = element_text(face = "bold", size = 11 * diagram_text_scale, hjust = 0.5))
...
kable(methods, caption = "Continuous Improvement Methodologies") %>%
  kable_styling(bootstrap_options = c("striped", "hover"), full_width = knitr::is_html_output()) %>%
  column_spec(1, bold = TRUE, width = if (knitr::is_html_output()) "15%" else NULL)
```
...
cat("─────────────────────────────\n")
cat("Total Cost of Quality: $", format(total_coq, big.mark = " ", scientific = FALSE), "\n")
...
cat("Conformance Costs (Prevention + Appraisal): $", format(conformance, big.mark = " ", scientific = FALSE),
    "(", round(conformance/total_coq*100, 1), "%)\n")
cat("Nonconformance Costs (Failures): $", format(nonconformance, big.mark = " ", scientific = FALSE),
...
ggplot(coq_data, aes(x = Category, y = Cost/1000, fill = Category)) +
  ...
  geom_text(aes(label = paste0("$", Cost/1000, "K\n(", Percent_of_COQ, "%)")),
            vjust = -0.2, size = 3.5 * diagram_text_scale) +
  scale_fill_manual(values = c("#27ae60", "#3498db", "#f39c12", "#e74c3c"), guide = "none") +
  scale_y_continuous(limits = c(0, 220), labels = scales::dollar_format(suffix = "K", big.mark = " ")) +
  annotate("rect", xmin = 0.5, xmax = 2.5, ymin = -10, ymax = -5, fill = "#27ae60", alpha = 0.3) +
  annotate("text", x = 1.5, y = -7.5, label = "Conformance Costs", size = 3 * diagram_text_scale) +
  annotate("rect", xmin = 2.5, xmax = 4.5, ymin = -10, ymax = -5, fill = "#e74c3c", alpha = 0.3) +
  annotate("text", x = 3.5, y = -7.5, label = "Nonconformance Costs", size = 3 * diagram_text_scale) +
  labs(title = "Cost of Quality Analysis",
       subtitle = paste0("Total COQ: $", format(total_coq, big.mark = " ", scientific = FALSE),
                        " (", round(total_coq/revenue*100, 1), "% of revenue)"),
       x = "", y = "Cost") +
  theme_minimal() +
  theme(
    plot.title = element_text(face = "bold", size = 14 * diagram_text_scale),
    axis.text.x = element_text(size = 11 * diagram_text_scale)
  )
```
...
ggplot(tools_map, aes(x = x, y = y)) +
  ...
  # Tool boxes
  geom_label(aes(label = Tool), fill = "white", fontface = "bold", size = 3.5 * diagram_text_scale) +
  geom_text(aes(label = QMS_Link, y = y - 0.35), size = 2.5 * diagram_text_scale, color = "gray40") +
  ...
  annotate("text", x = 4, y = 0.15, label = "Lessons Learned / Continuous Improvement",
           color = "#e74c3c", fontface = "italic", size = 3 * diagram_text_scale) +
  ...
  theme_void() +
  theme(
    plot.title = element_text(face = "bold", size = 14 * diagram_text_scale, hjust = 0.5),
    plot.subtitle = element_text(hjust = 0.5)
  )
```
...
ggplot(cert_steps, aes(x = x, y = 1)) +
  annotate("segment", x = 1, xend = 8, y = 1, yend = 1, color = "gray70", linewidth = 2) +
  geom_point(size = 12, color = "#3498db") +
  geom_text(aes(label = step), color = "white", fontface = "bold", size = 4 * diagram_text_scale) +
  geom_text(aes(label = name, y = 1.4), size = 3 * diagram_text_scale, fontface = "bold", angle = 45, hjust = 0) +
  geom_text(aes(label = duration, y = 0.6), size = 2.5 * diagram_text_scale, color = "gray50") +
...
cat("─────────────────────────────\n")
cat("Prevention:       $", format(prevention, big.mark = " ", scientific = FALSE),
    "(", round(prevention/total_coq*100, 1), "%)\n")
cat("Appraisal:        $", format(appraisal, big.mark = " ", scientific = FALSE),
    "(", round(appraisal/total_coq*100, 1), "%)\n")
cat("Internal Failure: $", format(internal_failure, big.mark = " ", scientific = FALSE),
    "(", round(internal_failure/total_coq*100, 1), "%)\n")
cat("External Failure: $", format(external_failure, big.mark = " ", scientific = FALSE),
    "(", round(external_failure/total_coq*100, 1), "%)\n")
cat("─────────────────────────────\n")
cat("Total COQ:        $", format(total_coq, big.mark = " ", scientific = FALSE), "\n")
...
cat("Conformance Costs:    $", format(conformance, big.mark = " ", scientific = FALSE),
    "(", round(conformance/total_coq*100, 1), "%)\n")
cat("Nonconformance Costs: $", format(nonconformance, big.mark = " ", scientific = FALSE),
    "(", round(nonconformance/total_coq*100, 1), "%)\n")
```
