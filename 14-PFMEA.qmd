...
ggplot() +
  ...
  annotate("text", x = 2, y = 2.5, label = "REACTIVE APPROACH", fontface = "bold",
           size = 4 * diagram_text_scale, color = "white") +
  ...
  annotate("text", x = 4.5, y = 2.2, label = "Shift from", size = 3 * diagram_text_scale) +
  theme_void() +
...
history %>%
  kable(caption = "Evolution of FMEA") %>%
...
ggplot() +
  ...
  annotate("text", x = 2.25, y = 4.5, label = "DFMEA", fontface = "bold", size = 6 * diagram_text_scale, color = "white") +
  annotate("text", x = 2.25, y = 4, label = "(Design FMEA)", size = 4 * diagram_text_scale, color = "white") +
  ...
  annotate("text", x = 7.75, y = 4.5, label = "PFMEA", fontface = "bold", size = 6 * diagram_text_scale, color = "white") +
  annotate("text", x = 7.75, y = 4, label = "(Process FMEA)", size = 4 * diagram_text_scale, color = "white") +
  ...
  annotate("segment", x = 4.5, xend = 5.5, y = 2.5, yend = 2.5,
           arrow = arrow(length = unit(0.2, "cm"), ends = "both"), linewidth = 1.5, color = "#2C3E50") +
  annotate("text", x = 5, y = 3, label = "Linked", size = 3 * diagram_text_scale, fontface = "italic") +
  theme_void() +
...
comparison %>%
  kable(caption = "DFMEA vs PFMEA Comparison") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
objectives %>%
  kable(caption = "Core Objectives of PFMEA") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
ggplot(team, aes(x = x, y = y)) +
  ...
  geom_text(aes(label = role), color = "white", fontface = "bold", size = 3.5 * diagram_text_scale,
            vjust = -0.3, lineheight = 0.8) +
  geom_text(aes(label = contribution), color = "white", size = 2.5 * diagram_text_scale,
...
terminology %>%
  kable(caption = "PFMEA Key Terminology") %>%
...
form_template %>%
  kable(caption = "PFMEA Form Template (Simplified)") %>%
...
scope_elements %>%
  kable(caption = "Step 1: Defining PFMEA Scope") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
ggplot() +
  ...
  annotate("text", x = 0.75, y = 0.2, label = "Function: Supply\ncorrect material",
           size = 2.5 * diagram_text_scale, fontface = "italic", lineheight = 0.9) +
...
failure_modes %>%
  kable(caption = "Step 3: Identifying Failure Modes") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
effects %>%
  kable(caption = "Step 4: Analyzing Effects at Multiple Levels") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
severity %>%
  kable(caption = "Severity Rating Scale (S)") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center", font_size = 11) %>%
  row_spec(0, bold = TRUE, background = "#E74C3C", color = "white") %>%
...
ggplot() +
  ...
  annotate("text", x = 1.2, y = 4.5, label = "• Worn screw\n• Clogged nozzle\n• Low pressure",
           size = 2.5 * diagram_text_scale, hjust = 0, lineheight = 0.9) +
...
occurrence %>%
  kable(caption = "Occurrence Rating Scale (O)") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center", font_size = 11) %>%
  row_spec(0, bold = TRUE, background = "#F39C12", color = "white") %>%
...
controls %>%
  kable(caption = "Types of Process Controls") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#27AE60", color = "white") %>%
  column_spec(1, bold = TRUE, width = "12em")
...
detection %>%
  kable(caption = "Detection Rating Scale (D)") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center", font_size = 11) %>%
  row_spec(0, bold = TRUE, background = "#9B59B6", color = "white") %>%
...
thresholds %>%
  kable(caption = "RPN Action Thresholds") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
...
ggplot(examples, aes(x = case)) +
  ...
  geom_text(aes(y = 11, label = paste0("RPN = ", RPN)), fontface = "bold", size = 4 * diagram_text_scale) +
  geom_text(aes(y = -1, label = issue), size = 3 * diagram_text_scale, lineheight = 0.9) +
  ...
  theme(
    plot.title = element_text(hjust = 0.5, face = "bold", size = 14 * diagram_text_scale),
    plot.subtitle = element_text(hjust = 0.5, size = 10 * diagram_text_scale, color = "#E74C3C"),
    legend.position = "bottom"
  ) +
  ylim(-2, 12)
```
...
ap_table %>%
  kable(caption = "Action Priority (AP) Method") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
actions_table %>%
  kable(caption = "Step 10: Recommended Actions with Targets") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered", "responsive"),
                full_width = knitr::is_html_output(), position = "center", font_size = 10) %>%
  row_spec(0, bold = TRUE, background = "#27AE60", color = "white") %>%
...
pfmea_example %>%
  kable(caption = "Complete PFMEA Example: Injection Molding Process") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered", "responsive"),
                full_width = knitr::is_html_output(), position = "center", font_size = 10) %>%
  row_spec(0, bold = TRUE, background = "#2C3E50", color = "white") %>%
...
ggplot(improvement_data, aes(x = option, y = RPN, fill = option)) +
  ...
  geom_text(aes(label = RPN), vjust = -0.5, fontface = "bold", size = 5 * diagram_text_scale) +
...
welding_pfmea %>%
  kable(caption = "PFMEA Example: Welding Process") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered", "responsive"),
                full_width = knitr::is_html_output(), position = "center", font_size = 11) %>%
...
heat_treat %>%
  kable(caption = "PFMEA Example: Heat Treatment Process") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered", "responsive"),
                full_width = knitr::is_html_output(), position = "center", font_size = 11) %>%
  row_spec(0, bold = TRUE, background = "#8E44AD", color = "white") %>%
...
food_pfmea %>%
  kable(caption = "PFMEA Example: Pasteurization Process") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered", "responsive"),
                full_width = knitr::is_html_output(), position = "center", font_size = 11) %>%
  row_spec(0, bold = TRUE, background = "#27AE60", color = "white") %>%
...
ggplot() +
  ...
  annotate("text", x = 5, y = 3, label = "PFMEA", fontface = "bold", size = 5 * diagram_text_scale, color = "white") +

  # Connected tools
  # Process Flow
  annotate("point", x = 2, y = 5, size = 18, color = "#3498DB") +
  annotate("text", x = 2, y = 5, label = "Process\nFlow", size = 3 * diagram_text_scale, color = "white", lineheight = 0.9) +
  annotate("segment", x = 2.8, xend = 4.2, y = 4.5, yend = 3.5, arrow = arrow(length = unit(0.15, "cm"))) +
  annotate("text", x = 3.2, y = 4.3, label = "Input", size = 2.5 * diagram_text_scale, color = "#3498DB") +

  # Control Plan
  annotate("point", x = 8, y = 5, size = 18, color = "#27AE60") +
  annotate("text", x = 8, y = 5, label = "Control\nPlan", size = 3 * diagram_text_scale, color = "white", lineheight = 0.9) +
  annotate("segment", x = 5.8, xend = 7.2, y = 3.5, yend = 4.5, arrow = arrow(length = unit(0.15, "cm"))) +
  annotate("text", x = 6.8, y = 4.3, label = "Output", size = 2.5 * diagram_text_scale, color = "#27AE60") +

  # SPC
  annotate("point", x = 8, y = 1, size = 18, color = "#F39C12") +
  annotate("text", x = 8, y = 1, label = "SPC", size = 3 * diagram_text_scale, color = "white") +
  annotate("segment", x = 5.8, xend = 7.2, y = 2.5, yend = 1.5, arrow = arrow(length = unit(0.15, "cm"))) +
  annotate("text", x = 6.8, y = 1.7, label = "Monitoring", size = 2.5 * diagram_text_scale, color = "#F39C12") +

  # DFMEA
  annotate("point", x = 2, y = 1, size = 18, color = "#9B59B6") +
  annotate("text", x = 2, y = 1, label = "DFMEA", size = 3 * diagram_text_scale, color = "white") +
  annotate("segment", x = 2.8, xend = 4.2, y = 1.5, yend = 2.5, arrow = arrow(length = unit(0.15, "cm"))) +
  annotate("text", x = 3.2, y = 1.7, label = "Link", size = 2.5 * diagram_text_scale, color = "#9B59B6") +
...
control_plan %>%
  kable(caption = "PFMEA to Control Plan Linkage") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#27AE60", color = "white")
```
...
pitfalls %>%
  kable(caption = "Common PFMEA Pitfalls and Solutions") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#E74C3C", color = "white") %>%
  column_spec(1, bold = TRUE, width = "12em") %>%
...
practices %>%
  kable(caption = "PFMEA Best Practices") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#27AE60", color = "white") %>%
  column_spec(1, bold = TRUE, width = "12em")
...
case_finding %>%
  kable(caption = "Case Study: Critical Failure Mode Identified") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = FALSE, position = "center") %>%
  row_spec(0, bold = TRUE, background = "#E74C3C", color = "white") %>%
...
summary_data %>%
  kable(caption = "PFMEA Key Concepts Summary") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#2C3E50", color = "white") %>%
