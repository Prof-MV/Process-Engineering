...
layout_data %>%
  kable(caption = "Material Handling Methods by Plant Layout") %>%
  kable_styling(
...
ggplot(stations, aes(x = x, y = y)) +
  ...
  geom_text(aes(label = name), color = "white", fontface = "bold", size = 4 * diagram_text_scale, y = 1.05) +
  geom_text(aes(label = paste0(time, " sec")), color = "white", size = 3.5 * diagram_text_scale, y = 0.95) +
...
transport_data %>%
  kable(caption = "Work Transport Methods in Production Lines") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"), full_width = knitr::is_html_output()) %>%
  row_spec(0, bold = TRUE, background = "#2C3E50", color = "white") %>%
...
ggplot(transport_viz, aes(x = x, y = y)) +
  ...
  annotate("segment", x = 0.5, xend = 5.5, y = 3, yend = 3, color = "#3498DB", linewidth = 2) +
  annotate("text", x = 3, y = 3.2, label = "v = constant", fontface = "italic", size = 3 * diagram_text_scale) +
  # Synchronous
  ...
  annotate("segment", x = 0.7, xend = 1.3, y = 2, yend = 2, color = "#E74C3C", linewidth = 2) +
  annotate("segment", x = 1.7, xend = 2.3, y = 2, yend = 2, color = "#E74C3C", linewidth = 2) +
  annotate("segment", x = 2.7, xend = 3.3, y = 2, yend = 2, color = "#E74C3C", linewidth = 2) +
  annotate("segment", x = 3.7, xend = 4.3, y = 2, yend = 2, color = "#E74C3C", linewidth = 2) +
  annotate("segment", x = 4.7, xend = 5.3, y = 2, yend = 2, color = "#E74C3C", linewidth = 2) +
  annotate("text", x = 3, y = 2.2, label = "All move together", fontface = "italic", size = 3 * diagram_text_scale) +
  # Asynchronous
  ...
  annotate("segment", x = 0.7, xend = 1.1, y = 1, yend = 1, color = "#27AE60", linewidth = 2) +
  annotate("segment", x = 1.9, xend = 2.5, y = 1, yend = 1, color = "#27AE60", linewidth = 2) +
  annotate("segment", x = 2.7, xend = 3.1, y = 1, yend = 1, color = "#27AE60", linewidth = 2) +
  annotate("segment", x = 4.0, xend = 4.4, y = 1, yend = 1, color = "#27AE60", linewidth = 2) +
  annotate("segment", x = 4.8, xend = 5.3, y = 1, yend = 1, color = "#27AE60", linewidth = 2) +
  annotate("text", x = 3, y = 1.2, label = "Independent movement + buffers", fontface = "italic", size = 3 * diagram_text_scale) +
  # Station markers
...
ggplot(cycle_data) +
  # Manual
  annotate("tile", x = 50, y = 3, width = 100, height = 0.5, fill = "#F39C12") +
  ...
  # Semi-automated
  annotate("tile", x = 20, y = 2, width = 40, height = 0.5, fill = "#F39C12") +
  annotate("tile", x = 70, y = 2, width = 60, height = 0.5, fill = "#3498DB") +
  annotate("text", x = 20, y = 2, label = "Load/Unload", color = "white", size = 3 * diagram_text_scale) +
  annotate("text", x = 70, y = 2, label = "Auto Cycle", color = "white", size = 3 * diagram_text_scale) +
  annotate("text", x = -10, y = 2, label = "Semi-Auto", fontface = "bold", hjust = 1) +
  # Fully automated
  annotate("tile", x = 2.5, y = 1, width = 5, height = 0.5, fill = "#F39C12") +
  annotate("tile", x = 52.5, y = 1, width = 95, height = 0.5, fill = "#3498DB") +
  annotate("text", x = 52.5, y = 1, label = "Automated Operation (Unattended)", color = "white", size = 3 * diagram_text_scale) +
  annotate("text", x = -10, y = 1, label = "Fully Auto", fontface = "bold", hjust = 1) +
  # Legend
  annotate("rect", xmin = 70, xmax = 75, ymin = 3.7, ymax = 3.9, fill = "#F39C12") +
  annotate("text", x = 77, y = 3.8, label = "Operator", hjust = 0, size = 3 * diagram_text_scale) +
  annotate("rect", xmin = 90, xmax = 95, ymin = 3.7, ymax = 3.9, fill = "#3498DB") +
  annotate("text", x = 97, y = 3.8, label = "Machine", hjust = 0, size = 3 * diagram_text_scale) +
...
time_metrics %>%
  kable(escape = FALSE, caption = "Key Manufacturing Time Metrics") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"), full_width = knitr::is_html_output()) %>%
...
ggplot(sim_data, aes(x = p * 100, y = Rp, color = Repair_Scenario)) +
  ...
  annotate("text", x = 1, y = 62, label = "Ideal Rate (60 parts/hr)", size = 3.5 * diagram_text_scale) +
...
p_cellular <- ggplot(cellular_machines, aes(x = x, y = y)) +
  ...
  geom_text(aes(label = Machine), size = 3 * diagram_text_scale, fontface = "bold") +
...
cellular_comparison %>%
  kable(caption = "Cellular Manufacturing Benefits vs. Traditional Process Layout") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"), full_width = knitr::is_html_output()) %>%
...
ggplot(fms_data, aes(x = x, y = y)) +
  ...
  annotate("path",
           ...
           color = "#95A5A6", linewidth = 3, linetype = "dashed") +
  ...
  geom_text(aes(label = Component), size = 3 * diagram_text_scale, fontface = "bold") +
  # Connections to central computer
  annotate("segment", x = 4, xend = 2.5, y = 2.4, yend = 2.3, linetype = "dotted") +
  annotate("segment", x = 4, xend = 4, y = 2.4, yend = 2.6, linetype = "dotted") +
  annotate("segment", x = 4, xend = 5.5, y = 2.4, yend = 2.3, linetype = "dotted") +
  annotate("segment", x = 4, xend = 4, y = 1.6, yend = 1.4, linetype = "dotted") +
  annotate("text", x = 5, y = 2.5, label = "Network\nConnections", size = 2.5 * diagram_text_scale, fontface = "italic") +
  scale_fill_identity() +
...
fms_apps %>%
  kable(caption = "FMS Characteristics and Applications") %>%
...
smed_steps %>%
  kable(caption = "SMED Methodology for Setup Reduction") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"), full_width = knitr::is_html_output()) %>%
...
agv_amr %>%
  kable(caption = "AGV vs. AMR Comparison") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"), full_width = knitr::is_html_output()) %>%
  row_spec(0, bold = TRUE, background = "#2C3E50", color = "white") %>%
...
ggplot(dt_data, aes(x = x, y = y)) +
  ...
  geom_text(aes(label = Component), color = "white", fontface = "bold", size = 3.5 * diagram_text_scale) +
  geom_segment(data = dt_data[1:4,], aes(x = x + 0.45, xend = x + 0.55, y = y, yend = y),
               arrow = arrow(length = unit(0.25, "cm")), color = "#2C3E50", linewidth = 1.2) +
  # Feedback loop
...
industry_apps %>%
  kable(caption = "Manufacturing System Applications by Industry") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"), full_width = knitr::is_html_output()) %>%
...
summary_ch3 %>%
  kable(caption = "Chapter 3 Summary") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"), full_width = knitr::is_html_output()) %>%
  row_spec(0, bold = TRUE, background = "#1A5276", color = "white") %>%
