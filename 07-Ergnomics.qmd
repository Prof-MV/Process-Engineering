...
ggplot() +
  ...
  annotate("text", x = 1, y = 2.3, label = "PHYSICAL", fontface = "bold", size = 5 * diagram_text_scale, color = "#2C3E50") +
  annotate("text", x = 1, y = 1.7, label = "Anatomy\nPhysiology\nBiomechanics", size = 3 * diagram_text_scale, lineheight = 0.9) +
  # Cognitive domain
  annotate("point", x = 3, y = 2, size = 45, color = "#E74C3C", alpha = 0.6) +
  annotate("text", x = 3, y = 2.3, label = "COGNITIVE", fontface = "bold", size = 5 * diagram_text_scale, color = "#2C3E50") +
  annotate("text", x = 3, y = 1.7, label = "Mental processes\nPerception\nDecision making", size = 3 * diagram_text_scale, lineheight = 0.9) +
  # Organizational domain
  annotate("point", x = 2, y = 0.5, size = 45, color = "#27AE60", alpha = 0.6) +
  annotate("text", x = 2, y = 0.8, label = "ORGANIZATIONAL", fontface = "bold", size = 5 * diagram_text_scale, color = "#2C3E50") +
  annotate("text", x = 2, y = 0.2, label = "Work systems\nTeamwork\nScheduling", size = 3 * diagram_text_scale, lineheight = 0.9) +
  # Center - Human
  annotate("point", x = 2, y = 1.5, size = 20, color = "#F39C12") +
  annotate("text", x = 2, y = 1.5, label = "HUMAN", fontface = "bold", size = 4 * diagram_text_scale, color = "white") +
  theme_void() +
...
domains %>%
  kable(caption = "The Three Domains of Ergonomics") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
ggplot(benefits, aes(x = reorder(category, improvement), y = improvement, fill = category)) +
  ...
  geom_text(aes(label = paste0(improvement, "%")), hjust = -0.2, fontface = "bold", size = 4 * diagram_text_scale) +
  coord_flip() +
  ...
  theme_minimal() +
  theme(
    plot.title = element_text(hjust = 0.5, face = "bold", size = 14 * diagram_text_scale),
    plot.subtitle = element_text(hjust = 0.5, size = 10 * diagram_text_scale),
...
ggplot(risk_factors, aes(x = x, y = risk_level, fill = factor)) +
  ...
  geom_text(aes(label = factor, y = risk_level/2), color = "white",
            fontface = "bold", size = 3.5 * diagram_text_scale, lineheight = 0.8) +
...
risk_detail %>%
  kable(caption = "The Seven Ergonomic Risk Factors Explained") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered", "responsive"),
                full_width = knitr::is_html_output(), position = "center", font_size = 11) %>%
...
ggplot() +
  ...
  annotate("text", x = 1.5, y = 2.5, label = "GREEN ZONE", fontface = "bold", size = 5 * diagram_text_scale, color = "white") +
  annotate("text", x = 1.5, y = 1.5, label = "Neutral Posture\n\nJoints at midpoint\nBalanced muscle load\nMinimal stress",
           size = 3.5 * diagram_text_scale, color = "white", lineheight = 0.9) +
  # Yellow zone - Moderate
  annotate("rect", xmin = 3.5, xmax = 6.5, ymin = 0, ymax = 3, fill = "#F39C12", alpha = 0.7) +
  annotate("text", x = 5, y = 2.5, label = "YELLOW ZONE", fontface = "bold", size = 5 * diagram_text_scale, color = "white") +
  ...
  annotate("text", x = 8.5, y = 2.5, label = "RED ZONE", fontface = "bold", size = 5 * diagram_text_scale, color = "white") +
...
neutral %>%
  kable(caption = "Neutral vs. Awkward Postures by Body Part") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
repetition %>%
  kable(caption = "Repetition Risk Thresholds") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
ggplot(force_data, aes(x = reorder(factor, impact), y = impact)) +
  ...
  geom_text(aes(label = example), hjust = -0.1, size = 3 * diagram_text_scale) +
  coord_flip() +
...
msd_detail %>%
  kable(caption = "Common Musculoskeletal Disorders in Manufacturing") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#E74C3C", color = "white") %>%
  column_spec(1, bold = TRUE, width = "12em")
...
ggplot(cycle_data, aes(x = x, y = severity)) +
  ...
  geom_text(aes(label = stage), color = "white", fontface = "bold", size = 3 * diagram_text_scale) +
  geom_text(aes(y = severity - 0.8, label = recovery), size = 3 * diagram_text_scale, fontface = "italic") +
  ...
  annotate("segment", x = 1, xend = 3, y = 5.5, yend = 5.5,
           arrow = arrow(length = unit(0.3, "cm"), ends = "both"), color = "#27AE60", linewidth = 1.5) +
...
ggplot(prevention, aes(x = 0, y = y)) +
  ...
  geom_text(aes(label = level), fontface = "bold", color = "white", size = 5 * diagram_text_scale) +
  geom_text(aes(x = 3.5, label = description), hjust = 0, size = 3.5 * diagram_text_scale, lineheight = 0.9) +
  ...
  annotate("text", x = -3.5, y = 2, label = "More\nEffective",
           angle = 90, fontface = "bold", size = 4 * diagram_text_scale) +
  theme_void() +
...
strategies %>%
  kable(caption = "MSD Prevention Strategies") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#27AE60", color = "white") %>%
...
ggplot() +
  ...
  annotate("text", x = 1, y = 4.5, label = "1. PLAN", fontface = "bold", color = "white", size = 4 * diagram_text_scale) +
  annotate("text", x = 1, y = 3.8, label = "Test weight\nClear path\nGet help if needed",
           color = "white", size = 2.5 * diagram_text_scale, lineheight = 0.9) +
  # Step 2
  annotate("rect", xmin = 2.5, xmax = 4.5, ymin = 3, ymax = 5, fill = "#27AE60", color = "black") +
  annotate("text", x = 3.5, y = 4.5, label = "2. POSITION", fontface = "bold", color = "white", size = 4 * diagram_text_scale) +
  annotate("text", x = 3.5, y = 3.8, label = "Feet shoulder-width\nClose to load\nBend knees",
           color = "white", size = 2.5 * diagram_text_scale, lineheight = 0.9) +
  # Step 3
  annotate("rect", xmin = 5, xmax = 7, ymin = 3, ymax = 5, fill = "#F39C12", color = "black") +
  annotate("text", x = 6, y = 4.5, label = "3. GRIP", fontface = "bold", color = "white", size = 4 * diagram_text_scale) +
  annotate("text", x = 6, y = 3.8, label = "Firm grip\nUse handles\nHold close",
           color = "white", size = 2.5 * diagram_text_scale, lineheight = 0.9) +
  # Step 4
  annotate("rect", xmin = 7.5, xmax = 9.5, ymin = 3, ymax = 5, fill = "#E74C3C", color = "black") +
  annotate("text", x = 8.5, y = 4.5, label = "4. LIFT", fontface = "bold", color = "white", size = 4 * diagram_text_scale) +
  ...
  annotate("text", x = 2.5, y = 2.2, label = "DO:", fontface = "bold", color = "#27AE60", size = 4 * diagram_text_scale) +
  annotate("text", x = 2.5, y = 1.3, label = "• Lift with legs\n• Keep load close\n• Pivot feet to turn\n• Ask for help",
           size = 3 * diagram_text_scale, lineheight = 0.9, hjust = 0.5) +
  # DON'T section
  annotate("rect", xmin = 5, xmax = 9, ymin = 0.5, ymax = 2.5, fill = "#FADBD8", color = "#E74C3C") +
  annotate("text", x = 7, y = 2.2, label = "DON'T:", fontface = "bold", color = "#E74C3C", size = 4 * diagram_text_scale) +
...
ggplot(principles, aes(x = x, y = y)) +
  ...
  geom_text(aes(label = principle), color = "white", fontface = "bold", size = 3.5 * diagram_text_scale,
            lineheight = 0.9) +
  theme_void() +
...
principles_detail %>%
  kable(caption = "Ergonomic Design Principles in Detail") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
ggplot() +
  ...
  stat_function(fun = dnorm, args = list(mean = 170, sd = 10),
                xlim = c(140, 200), linewidth = 2, color = "#3498DB") +
  # Percentile lines
  ...
  annotate("text", x = 153.5, y = 0.035, label = "5th\npercentile",
           size = 3 * diagram_text_scale, color = "#E74C3C", vjust = 0) +
  annotate("text", x = 170, y = 0.042, label = "50th\npercentile",
           size = 3 * diagram_text_scale, color = "#F39C12", vjust = 0) +
  annotate("text", x = 186.5, y = 0.035, label = "95th\npercentile",
           size = 3 * diagram_text_scale, color = "#27AE60", vjust = 0) +
  # Design range
  ...
  annotate("text", x = 170, y = -0.005, label = "Design Range (90% of population)",
           color = "#9B59B6", fontface = "bold", size = 3.5 * diagram_text_scale) +
...
anthro_data %>%
  kable(caption = "Key Anthropometric Measurements for Workstation Design") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered", "responsive"),
                full_width = knitr::is_html_output(), position = "center", font_size = 11) %>%
  row_spec(0, bold = TRUE, background = "#9B59B6", color = "white") %>%
  column_spec(1, bold = TRUE, width = "14em")
...
ggplot() +
  ...
  # Labels
  annotate("text", x = 1, y = 115, label = "Precision\n100-110cm", size = 3 * diagram_text_scale, lineheight = 0.9) +
  annotate("text", x = 2, y = 100, label = "Light Assembly\n85-95cm", size = 3 * diagram_text_scale, lineheight = 0.9) +
  annotate("text", x = 3, y = 90, label = "Heavy Work\n70-85cm", size = 3 * diagram_text_scale, lineheight = 0.9) +
  ...
  annotate("text", x = 3.7, y = 105, label = "Elbow Height\n(standing)",
           hjust = 0, size = 3 * diagram_text_scale, color = "#E74C3C") +
...
tools %>%
  kable(caption = "Common Ergonomic Assessment Tools") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
ggplot() +
  ...
  annotate("text", x = 4.5, y = 1.5, label = "Score C\n+ Activity", size = 3 * diagram_text_scale, color = "white", lineheight = 0.9) +
  # Arrows to C
  ...
  annotate("text", x = 4.5, y = 0, label = "REBA SCORE\n(1-15)", fontface = "bold", size = 4 * diagram_text_scale, color = "white", lineheight = 0.9) +
...
trunk %>%
  kable(caption = "REBA Trunk Posture Scores") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
...
neck %>%
  kable(caption = "REBA Neck Posture Scores") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = FALSE, position = "center") %>%
  row_spec(0, bold = TRUE, background = "#3498DB", color = "white")
```
...
action %>%
  kable(caption = "REBA Action Levels") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = FALSE, position = "center") %>%
...
neck_full %>%
  kable(caption = "REBA Neck Posture Scoring") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = FALSE, position = "center") %>%
  row_spec(0, bold = TRUE, background = "#3498DB", color = "white") %>%
  row_spec(1, background = "#D5F5E3") %>%
...
trunk_full %>%
  kable(caption = "REBA Trunk Posture Scoring") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = FALSE, position = "center") %>%
  row_spec(0, bold = TRUE, background = "#3498DB", color = "white") %>%
  row_spec(1, background = "#D5F5E3") %>%
...
legs_full %>%
  kable(caption = "REBA Legs Posture Scoring") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = FALSE, position = "center") %>%
  row_spec(0, bold = TRUE, background = "#3498DB", color = "white")
```
...
table_a %>%
  kable(caption = "REBA Table A: Posture Score A (Trunk × Neck × Legs)",
...
load_score %>%
  kable(caption = "REBA Load/Force Scoring") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = FALSE, position = "center") %>%
  row_spec(0, bold = TRUE, background = "#2980B9", color = "white") %>%
  row_spec(1, background = "#D5F5E3") %>%
...
upper_arm %>%
  kable(caption = "REBA Upper Arm Posture Scoring") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center", font_size = 11) %>%
  row_spec(0, bold = TRUE, background = "#C0392B", color = "white") %>%
  row_spec(1, background = "#D5F5E3") %>%
...
lower_arm %>%
  kable(caption = "REBA Lower Arm Posture Scoring") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = FALSE, position = "center") %>%
  row_spec(0, bold = TRUE, background = "#C0392B", color = "white") %>%
  row_spec(1, background = "#D5F5E3") %>%
...
wrist %>%
  kable(caption = "REBA Wrist Posture Scoring") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = FALSE, position = "center") %>%
  row_spec(0, bold = TRUE, background = "#C0392B", color = "white") %>%
  row_spec(1, background = "#D5F5E3") %>%
...
table_b %>%
  kable(caption = "REBA Table B: Posture Score B (Upper Arm × Lower Arm × Wrist)",
...
coupling %>%
  kable(caption = "REBA Coupling Score") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center", font_size = 11) %>%
  row_spec(0, bold = TRUE, background = "#C0392B", color = "white") %>%
  row_spec(1, background = "#D5F5E3") %>%
...
table_c %>%
  kable(caption = "REBA Table C: Combined Score (Score A × Score B)",
        col.names = c("Score A", paste0("B=", 1:12))) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center", font_size = 10) %>%
  row_spec(0, bold = TRUE, background = "#27AE60", color = "white") %>%
...
activity %>%
  kable(caption = "REBA Activity Score (Add +1 for each condition present)") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#27AE60", color = "white")
```
...
final_action %>%
  kable(caption = "REBA Action Level Guidelines") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#F39C12", color = "white") %>%
  row_spec(1, background = "#D5F5E3") %>%
...
ggplot() +
  ...
  # Arms reaching down
  annotate("segment", x = 4.5, xend = 3, y = 5.5, yend = 3, color = "#D4AC0D", linewidth = 3) +
  annotate("segment", x = 5.5, xend = 7, y = 5.5, yend = 4, color = "#D4AC0D", linewidth = 3) +
  # Bin (low position)
  annotate("rect", xmin = 1, xmax = 3.5, ymin = 0.5, ymax = 2.5, fill = "#85C1E9", color = "black") +
  annotate("text", x = 2.25, y = 1.5, label = "BIN\n(Low)", fontface = "bold", size = 3 * diagram_text_scale) +
  # Conveyor (higher position)
  annotate("rect", xmin = 6.5, xmax = 9.5, ymin = 3, ymax = 4.5, fill = "#ABEBC6", color = "black") +
  annotate("text", x = 8, y = 3.75, label = "CONVEYOR", fontface = "bold", size = 3 * diagram_text_scale) +
  # Annotations
  annotate("segment", x = 5, xend = 5, y = 6.5, yend = 7.5,
           arrow = arrow(length = unit(0.15, "cm"), ends = "both"), color = "#E74C3C") +
  annotate("text", x = 5.8, y = 7, label = "Neck: 25°\nflexion", size = 2.5 * diagram_text_scale, color = "#E74C3C", hjust = 0) +
  annotate("curve", x = 5, y = 4, xend = 4.5, yend = 2.5, curvature = -0.3,
           arrow = arrow(length = unit(0.15, "cm")), color = "#E74C3C") +
  annotate("text", x = 3.5, y = 3, label = "Trunk: 40°\nflexion", size = 2.5 * diagram_text_scale, color = "#E74C3C") +
  annotate("text", x = 2, y = 4.5, label = "Upper arm:\n50° flexion", size = 2.5 * diagram_text_scale, color = "#3498DB") +
  # Title and info boxes
  annotate("rect", xmin = 0.5, xmax = 4, ymin = 5.5, ymax = 8, fill = "#FADBD8", alpha = 0.8) +
  annotate("text", x = 2.25, y = 7.5, label = "GROUP A (Blue)", fontface = "bold", size = 3 * diagram_text_scale) +
  annotate("text", x = 2.25, y = 6.5, label = "Trunk + Neck + Legs", size = 2.5 * diagram_text_scale) +
  annotate("rect", xmin = 6, xmax = 9.5, ymin = 5.5, ymax = 8, fill = "#D6EAF8", alpha = 0.8) +
  annotate("text", x = 7.75, y = 7.5, label = "GROUP B (Red)", fontface = "bold", size = 3 * diagram_text_scale) +
  annotate("text", x = 7.75, y = 6.5, label = "Arms + Wrist", size = 2.5 * diagram_text_scale) +
  theme_void() +
...
recommendations %>%
  kable(caption = "Recommended Interventions Based on REBA Assessment") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#27AE60", color = "white") %>%
...
niosh %>%
  kable(caption = "NIOSH Lifting Equation Factors") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
li_interp %>%
  kable(caption = "Lifting Index Interpretation") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = FALSE, position = "center") %>%
  row_spec(0, bold = TRUE, background = "#8E44AD", color = "white") %>%
  row_spec(1, background = "#D5F5E3") %>%
...
ggplot() +
  ...
  annotate("text", x = 1, y = 2.5, label = "INPUT", fontface = "bold", color = "white", size = 4 * diagram_text_scale) +
  annotate("text", x = 1, y = 1.7, label = "Video/\nWearables", color = "white", size = 3 * diagram_text_scale) +
  # Processing
  annotate("rect", xmin = 3, xmax = 5, ymin = 1, ymax = 3, fill = "#9B59B6", color = "black") +
  annotate("text", x = 4, y = 2.5, label = "AI PROCESSING", fontface = "bold", color = "white", size = 4 * diagram_text_scale) +
  annotate("text", x = 4, y = 1.7, label = "Pose\nEstimation", color = "white", size = 3 * diagram_text_scale) +
  # Analysis
  annotate("rect", xmin = 6, xmax = 8, ymin = 1, ymax = 3, fill = "#E74C3C", color = "black") +
  annotate("text", x = 7, y = 2.5, label = "ANALYSIS", fontface = "bold", color = "white", size = 4 * diagram_text_scale) +
  annotate("text", x = 7, y = 1.7, label = "REBA/RULA\nScoring", color = "white", size = 3 * diagram_text_scale) +
  # Output
  annotate("rect", xmin = 9, xmax = 11, ymin = 1, ymax = 3, fill = "#27AE60", color = "black") +
  annotate("text", x = 10, y = 2.5, label = "OUTPUT", fontface = "bold", color = "white", size = 4 * diagram_text_scale) +
  annotate("text", x = 10, y = 1.7, label = "Risk Report\nAlerts", color = "white", size = 3 * diagram_text_scale) +
  # Arrows
...
ai_tools %>%
  kable(caption = "AI-Powered Ergonomic Assessment Tools") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#9B59B6", color = "white") %>%
  column_spec(1, bold = TRUE, width = "12em")
...
ggplot(comparison_long, aes(x = metric, y = value, fill = method)) +
  ...
  geom_text(aes(label = paste0(value, ifelse(metric %in% c("Consistency", "Real-time Feedback"), "%", ""))),
            position = position_dodge(width = 0.7), vjust = -0.5, size = 3 * diagram_text_scale) +
...
automation_ergo %>%
  kable(caption = "Ergonomic Considerations for Automated Systems") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
cobot_ergo %>%
  kable(caption = "Ergonomic Considerations for Collaborative Robots") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
employer_resp %>%
  kable(caption = "Employer Ergonomics Program Responsibilities") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#C0392B", color = "white") %>%
  column_spec(1, bold = TRUE, width = "12em")
...
findings %>%
  kable(caption = "Ergonomic Assessment Findings") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#E74C3C", color = "white") %>%
...
ggplot(results_long, aes(x = metric, y = change)) +
  ...
  geom_text(aes(label = paste0(ifelse(change > 0, "+", ""), round(change), "%")),
            vjust = ifelse(results_long$change < 0, 1.5, -0.5), fontface = "bold", size = 4 * diagram_text_scale) +
...
cat("Total Investment: $", format(total_investment, big.mark = " ", scientific = FALSE), "\n")
cat("Annual Savings: $", format(annual_savings, big.mark = " ", scientific = FALSE), "\n")
...
summary_data %>%
  kable(caption = "Ergonomics in Manufacturing: Key Concepts Summary") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
