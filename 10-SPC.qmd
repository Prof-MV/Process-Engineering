...
ggplot() +
  ...
  annotate("text", x = 2, y = 2.5, label = "WITHOUT SPC", fontface = "bold", size = 4 * diagram_text_scale, color = "white") +
  ...
  annotate("text", x = 7, y = 2.5, label = "WITH SPC", fontface = "bold", size = 4 * diagram_text_scale, color = "white") +
...
history %>%
  kable(caption = "Evolution of Statistical Process Control") %>%
...
ggplot(df, aes(x = sample, y = value)) +
  ...
  annotate("text", x = 52, y = 56.5, label = "UCL", color = "#E74C3C", size = 3 * diagram_text_scale) +
  annotate("text", x = 52, y = 43.5, label = "LCL", color = "#E74C3C", size = 3 * diagram_text_scale) +
  ...
  theme(
    plot.title = element_text(hjust = 0.5, face = "bold", size = 14 * diagram_text_scale),
    plot.subtitle = element_text(hjust = 0.5, size = 10 * diagram_text_scale),
    strip.text = element_text(face = "bold", size = 11 * diagram_text_scale)
  )
```
...
variation_types %>%
  kable(caption = "Common Cause vs. Special Cause Variation") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
ggplot() +
  ...
  annotate("text", x = 2.25, y = 2.6, label = "MISTAKE #1", fontface = "bold", size = 4 * diagram_text_scale, color = "white") +
  annotate("text", x = 2.25, y = 2.2, label = "Over-adjustment", size = 3.5 * diagram_text_scale, color = "white", fontface = "italic") +
  ...
  annotate("text", x = 7.75, y = 2.6, label = "MISTAKE #2", fontface = "bold", size = 4 * diagram_text_scale, color = "white") +
  annotate("text", x = 7.75, y = 2.2, label = "Under-reaction", size = 3.5 * diagram_text_scale, color = "white", fontface = "italic") +
...
ggplot(data, aes(x = subgroup, y = value)) +
  ...
  annotate("text", x = 26, y = mean_val - 2*sd(data$value[-18]), label = "-2σ", hjust = 0, color = "#F39C12") +
  # Zone labels
  annotate("text", x = 0, y = mean_val + 2.5*sd(data$value[-18]), label = "Zone A", hjust = 1, size = 3 * diagram_text_scale) +
  annotate("text", x = 0, y = mean_val + 1.5*sd(data$value[-18]), label = "Zone B", hjust = 1, size = 3 * diagram_text_scale) +
  annotate("text", x = 0, y = mean_val + 0.5*sd(data$value[-18]), label = "Zone C", hjust = 1, size = 3 * diagram_text_scale) +
  scale_color_manual(values = c("FALSE" = "#3498DB", "TRUE" = "#E74C3C"), guide = "none") +
...
components %>%
  kable(caption = "Control Chart Components") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
ggplot(df, aes(x = x, y = y)) +
  ...
  annotate("text", x = 0, y = 0.2, label = "68.27%\n(±1σ)", size = 3 * diagram_text_scale, fontface = "bold") +
  annotate("text", x = 1.5, y = 0.1, label = "95.45%\n(±2σ)", size = 3 * diagram_text_scale) +
  annotate("text", x = 2.5, y = 0.03, label = "99.73%\n(±3σ)", size = 3 * diagram_text_scale) +
  annotate("text", x = 3.5, y = 0.01, label = "0.135%", size = 2.5 * diagram_text_scale, color = "#E74C3C") +
  annotate("text", x = -3.5, y = 0.01, label = "0.135%", size = 2.5 * diagram_text_scale, color = "#E74C3C") +
...
ggplot() +
  ...
  annotate("text", x = 3.5, y = 4.2, label = "n≥10", size = 2.5 * diagram_text_scale) +
  ...
  annotate("text", x = 9.7, y = 4.2, label = "Defects\n(count per unit)", size = 2.5 * diagram_text_scale, lineheight = 0.9) +
...
chart_types %>%
  kable(caption = "Control Chart Summary") %>%
...
p1 <- ggplot(plot_data, aes(x = subgroup, y = xbar)) +
  ...
  scale_color_manual(values = c("FALSE" = "#3498DB", "TRUE" = "#E74C3C"), guide = "none") +
  annotate("text", x = 26, y = UCL_xbar, label = paste("UCL =", round(UCL_xbar, 3)), hjust = 0, size = 3 * diagram_text_scale) +
  annotate("text", x = 26, y = X_double_bar, label = paste("CL =", round(X_double_bar, 3)), hjust = 0, size = 3 * diagram_text_scale) +
  annotate("text", x = 26, y = LCL_xbar, label = paste("LCL =", round(LCL_xbar, 3)), hjust = 0, size = 3 * diagram_text_scale) +
...
p2 <- ggplot(plot_data, aes(x = subgroup, y = R)) +
  ...
  annotate("text", x = 26, y = UCL_R, label = paste("UCL =", round(UCL_R, 3)), hjust = 0, size = 3 * diagram_text_scale) +
  annotate("text", x = 26, y = R_bar, label = paste("CL =", round(R_bar, 3)), hjust = 0, size = 3 * diagram_text_scale) +
  annotate("text", x = 26, y = LCL_R, label = "LCL = 0", hjust = 0, size = 3 * diagram_text_scale) +
...
```{webr-r}
#| label: xbar-r-live
# Subgroup averages (X-bar) and ranges (R) for 10 subgroups
xbar <- c(25.01, 24.99, 25.02, 25.00, 25.03, 25.01, 25.12, 25.02, 24.98, 25.00)
R    <- c(0.08, 0.11, 0.07, 0.09, 0.10, 0.08, 0.09, 0.12, 0.07, 0.10)
...
cat("  CL  =", round(X_double_bar, 4), "\n")
cat("  LCL =", round(LCL_xbar, 4), "\n\n")

cat("R Chart:\n")
cat("  UCL =", round(UCL_R, 4), "\n")
cat("  CL  =", round(R_bar, 4), "\n")
cat("  LCL =", round(LCL_R, 4), "\n\n")

out_of_control <- which(xbar > UCL_xbar | xbar < LCL_xbar)
if (length(out_of_control) > 0) {
  cat("Out-of-control subgroup(s):", out_of_control, "\n")
} else {
  cat("All subgroups within control limits.\n")
}
```
...
constants %>%
  kable(caption = "Control Chart Constants for X-bar/R Charts") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
...
```{webr-r}
#| label: imr-live
individuals <- c(100.2, 99.8, 100.5, 100.1, 99.6, 100.3, 100.0, 99.9,
                  100.4, 106.1, 105.8, 106.3)

MR <- c(NA, abs(diff(individuals)))

X_bar <- mean(individuals)
...
cat("I Chart:\n")
cat("  UCL =", round(UCL_I, 3), "\n")
cat("  CL  =", round(X_bar, 3), "\n")
cat("  LCL =", round(LCL_I, 3), "\n\n")

cat("MR Chart:\n")
cat("  UCL =", round(UCL_MR, 3), "\n")
cat("  CL  =", round(MR_bar, 3), "\n")
cat("  LCL = 0\n\n")

out_of_control <- which(individuals > UCL_I | individuals < LCL_I)
if (length(out_of_control) > 0) {
  cat("Out-of-control observation(s):", out_of_control, "\n")
} else {
  cat("All observations within control limits.\n")
}
```
...
```{webr-r}
#| label: p-chart-live
sample_sizes <- c(100, 95, 110, 105, 90, 100, 115, 100, 95, 108)
defectives   <- c(4, 5, 6, 3, 4, 5, 15, 4, 6, 5)
...
for (i in seq_along(p)) {
  cat(sprintf("%3d  %3d  %.4f  %.4f  %.4f\n", i, sample_sizes[i], p[i], UCL_p[i], LCL_p[i]))
}

out_of_control <- which(p > UCL_p | p < LCL_p)
if (length(out_of_control) > 0) {
  cat("\nOut-of-control day(s):", out_of_control, "\n")
} else {
  cat("\nAll days within control limits.\n")
}
```
...
```{webr-r}
#| label: c-chart-live
defects <- c(7, 9, 6, 8, 10, 7, 8, 9, 6, 19, 8, 7)

c_bar <- mean(defects)
UCL_c <- c_bar + 3 * sqrt(c_bar)
LCL_c <- max(0, c_bar - 3 * sqrt(c_bar))

cat("c-bar (average defects per unit):", round(c_bar, 2), "\n")
cat("UCL =", round(UCL_c, 2), "\n")
cat("LCL =", round(LCL_c, 2), "\n\n")

out_of_control <- which(defects > UCL_c | defects < LCL_c)
if (length(out_of_control) > 0) {
  cat("Out-of-control sample(s):", out_of_control, "\n")
} else {
  cat("All samples within control limits.\n")
}
```
...
attr_formulas %>%
  kable(escape = FALSE, caption = "Attribute Control Chart Formulas") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
we_rules %>%
  kable(caption = "Western Electric Rules for Control Chart Interpretation") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
patterns %>%
  kable(caption = "Additional Control Chart Patterns") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#9B59B6", color = "white") %>%
...
ggplot(data.frame(x, y), aes(x, y)) +
  ...
  annotate("segment", x = -3, xend = 3, y = -0.07, yend = -0.07,
           arrow = arrow(length = unit(0.15, "cm"), ends = "both"), linewidth = 1, color = "#3498DB") +
...
indices %>%
  kable(escape = FALSE, caption = "Process Capability Indices") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
Live cell — try different specification limits, process mean, and sigma to see how Cp and Cpk respond.
...
cap_interp %>%
  kable(caption = "Capability Index Interpretation Guide") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
checklist %>%
  kable(caption = "Investigation Checklist: 5 Ms + E") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#E74C3C", color = "white") %>%
  column_spec(1, bold = TRUE, width = "10em")
...
impl_steps %>%
  kable(caption = "SPC Implementation Steps") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#16A085", color = "white") %>%
...
mistakes %>%
  kable(caption = "Common SPC Mistakes and Corrections") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#E74C3C", color = "white") %>%
...
summary_data %>%
  kable(caption = "SPC Key Concepts Summary") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
