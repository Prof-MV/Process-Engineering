...
ggplot() +
  ...
  annotate("text", x = 1.5, y = 2.5, label = "TOTAL", fontface = "bold", size = 6 * diagram_text_scale, color = "white") +
  annotate("text", x = 1.5, y = 1.5, label = "Everyone\nparticipates\n\nAll departments\nAll levels",
           size = 4 * diagram_text_scale, color = "white", lineheight = 0.9) +
  # Productive
  annotate("rect", xmin = 3.5, xmax = 6.5, ymin = 0, ymax = 3, fill = "#27AE60", alpha = 0.8) +
  annotate("text", x = 5, y = 2.5, label = "PRODUCTIVE", fontface = "bold", size = 6 * diagram_text_scale, color = "white") +
  annotate("text", x = 5, y = 1.5, label = "Maximize\neffectiveness\n\nZero losses\nZero defects",
           size = 4 * diagram_text_scale, color = "white", lineheight = 0.9) +
  # Maintenance
  annotate("rect", xmin = 7, xmax = 10, ymin = 0, ymax = 3, fill = "#E74C3C", alpha = 0.8) +
  annotate("text", x = 8.5, y = 2.5, label = "MAINTENANCE", fontface = "bold", size = 6 * diagram_text_scale, color = "white") +
...
history %>%
  kable(caption = "Evolution of Maintenance Philosophy") %>%
...
ggplot(goals, aes(x = x, y = 1)) +
  ...
  geom_text(aes(label = goal), y = 1, color = "white", fontface = "bold", size = 4 * diagram_text_scale, lineheight = 0.9) +
  geom_text(aes(label = impact), y = 0.3, color = "#2C3E50", size = 4.5 * diagram_text_scale, lineheight = 0.9) +
  annotate("segment", x = 0.3, xend = 3.7, y = 0.6, yend = 0.6,
           arrow = arrow(length = unit(0.2, "cm"), ends = "both"), color = "#27AE60", linewidth = 1.5) +
  annotate("text", x = 2, y = 0.5, label = "= Maximum OEE", color = "#27AE60", fontface = "bold", size = 4 * diagram_text_scale) +
  theme_void() +
...
comparison %>%
  kable(caption = "Traditional Maintenance vs. TPM") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
ggplot() +
  ...
  annotate("text", x = 5, y = 0.5, label = "FOUNDATION: 5S (Sort, Set in Order, Shine, Standardize, Sustain)",
           color = "white", fontface = "bold", size = 4.5 * diagram_text_scale) +
  # Roof
  ...
  annotate("text", x = 0.65, y = 3.1, label = "Autonomous\nMaintenance", color = "white",
           fontface = "bold", size = 3.5 * diagram_text_scale, lineheight = 0.9, angle = 90) +
  # Pillar 2
...
pillars %>%
  kable(caption = "The Eight Pillars of TPM") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered", "responsive"),
                full_width = knitr::is_html_output(), position = "center", font_size = 13) %>%
...
ggplot() +
  ...
  annotate("text", x = 5, y = 5, label = "OEE = Availability × Performance × Quality",
           color = "white", fontface = "bold", size = 6 * diagram_text_scale) +

  # Three components
  # Availability
  annotate("rect", xmin = 0.5, xmax = 3, ymin = 2, ymax = 4, fill = "#3498DB", color = "black") +
  annotate("text", x = 1.75, y = 3.6, label = "AVAILABILITY", color = "white", fontface = "bold", size = 5 * diagram_text_scale) +
  annotate("text", x = 1.75, y = 3, label = "Run Time\n÷\nPlanned Production Time",
           color = "white", size = 4 * diagram_text_scale, lineheight = 0.9) +
  annotate("text", x = 1.75, y = 1.5, label = "Downtime\nLosses", color = "#3498DB",
           fontface = "bold", size = 4 * diagram_text_scale, lineheight = 0.9) +

  # Performance
  annotate("rect", xmin = 3.5, xmax = 6.5, ymin = 2, ymax = 4, fill = "#27AE60", color = "black") +
  annotate("text", x = 5, y = 3.6, label = "PERFORMANCE", color = "white", fontface = "bold", size = 5 * diagram_text_scale) +
  ...
  annotate("text", x = 8.25, y = 3.6, label = "QUALITY", color = "white", fontface = "bold", size = 5 * diagram_text_scale) +
  ...
  theme(plot.title = element_text(hjust = 0.5, face = "bold", size = 16 * diagram_text_scale)) +
  ylim(1, 6)
```
...
oee_formulas %>%
  kable(escape = FALSE, caption = "OEE Component Formulas") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
ggplot(waterfall, aes(x = category)) +
  ...
  theme_minimal() +
  theme(
    plot.title = element_text(hjust = 0.5, face = "bold", size = 16 * diagram_text_scale),
...
ggplot() +
  ...
  annotate("text", x = 1.6, y = 6.2, label = "AVAILABILITY LOSSES", fontface = "bold",
           color = "#3498DB", size = 4 * diagram_text_scale) +
  annotate("rect", xmin = 0.2, xmax = 1.4, ymin = 4.2, ymax = 5.8, fill = "#3498DB", color = "black") +
  annotate("text", x = 0.8, y = 5.4, label = "1", fontface = "bold", color = "white", size = 5 * diagram_text_scale) +
  annotate("text", x = 0.8, y = 5, label = "Equipment\nFailure", color = "white", size = 4 * diagram_text_scale, lineheight = 0.9) +
  annotate("rect", xmin = 1.6, xmax = 3, ymin = 4.2, ymax = 5.8, fill = "#3498DB", color = "black") +
  annotate("text", x = 2.3, y = 5.4, label = "2", fontface = "bold", color = "white", size = 5 * diagram_text_scale) +
  annotate("text", x = 2.3, y = 5, label = "Setup &\nAdjustment", color = "white", size = 4 * diagram_text_scale, lineheight = 0.9) +
  ...
  annotate("text", x = 5, y = 6.2, label = "PERFORMANCE LOSSES", fontface = "bold",
           color = "#27AE60", size = 4 * diagram_text_scale) +
  annotate("rect", xmin = 3.6, xmax = 4.8, ymin = 4.2, ymax = 5.8, fill = "#27AE60", color = "black") +
  annotate("text", x = 4.2, y = 5.4, label = "3", fontface = "bold", color = "white", size = 5 * diagram_text_scale) +
  annotate("text", x = 4.2, y = 5, label = "Idling &\nMinor Stops", color = "white", size = 4 * diagram_text_scale, lineheight = 0.9) +
  annotate("rect", xmin = 5, xmax = 6.4, ymin = 4.2, ymax = 5.8, fill = "#27AE60", color = "black") +
  annotate("text", x = 5.7, y = 5.4, label = "4", fontface = "bold", color = "white", size = 5 * diagram_text_scale) +
  annotate("text", x = 5.7, y = 5, label = "Reduced\nSpeed", color = "white", size = 4 * diagram_text_scale, lineheight = 0.9) +
  ...
  annotate("text", x = 8.4, y = 6.2, label = "QUALITY LOSSES", fontface = "bold",
           color = "#E74C3C", size = 4 * diagram_text_scale) +
  annotate("rect", xmin = 7, xmax = 8.2, ymin = 4.2, ymax = 5.8, fill = "#E74C3C", color = "black") +
  annotate("text", x = 7.6, y = 5.4, label = "5", fontface = "bold", color = "white", size = 5 * diagram_text_scale) +
  annotate("text", x = 7.6, y = 5, label = "Process\nDefects", color = "white", size = 4 * diagram_text_scale, lineheight = 0.9) +
  annotate("rect", xmin = 8.4, xmax = 9.8, ymin = 4.2, ymax = 5.8, fill = "#E74C3C", color = "black") +
  annotate("text", x = 9.1, y = 5.4, label = "6", fontface = "bold", color = "white", size = 5 * diagram_text_scale) +
  annotate("text", x = 9.1, y = 5, label = "Startup\nRejects", color = "white", size = 4 * diagram_text_scale, lineheight = 0.9) +
...
losses_detail %>%
  kable(caption = "The Six Big Losses Explained") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered", "responsive"),
                full_width = knitr::is_html_output(), position = "center", font_size = 13) %>%
...
ggplot(steps, aes(x = 1, y = y)) +
  ...
  geom_text(aes(x = 0.2, label = step), fontface = "bold", color = "white", size = 5.5 * diagram_text_scale) +
  geom_text(aes(x = 1.2, label = name), fontface = "bold", color = "white", size = 4.5 * diagram_text_scale) +
  geom_text(aes(x = 2.8, label = description), hjust = 0, color = "#2C3E50", size = 4.5 * diagram_text_scale) +
...
am_steps %>%
  kable(caption = "Autonomous Maintenance Steps in Detail") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
ggplot() +
  ...
  annotate("text", x = 1.5, y = 2.5, label = "YELLOW TAG", fontface = "bold", color = "black", size = 5 * diagram_text_scale) +
  annotate("text", x = 1.5, y = 1.5, label = "Safety\nHazard\n\nImmediate attention",
           color = "black", size = 4 * diagram_text_scale, lineheight = 0.9) +
  # Red tag
  annotate("rect", xmin = 3.5, xmax = 5.5, ymin = 0, ymax = 3, fill = "#E74C3C", color = "black") +
  annotate("text", x = 4.5, y = 2.5, label = "RED TAG", fontface = "bold", color = "white", size = 5 * diagram_text_scale) +
  annotate("text", x = 4.5, y = 1.5, label = "Maintenance\nRequired\n\nOperator cannot fix",
           color = "white", size = 4 * diagram_text_scale, lineheight = 0.9) +
  # Blue tag
  annotate("rect", xmin = 6.5, xmax = 8.5, ymin = 0, ymax = 3, fill = "#3498DB", color = "black") +
  annotate("text", x = 7.5, y = 2.5, label = "BLUE TAG", fontface = "bold", color = "white", size = 5 * diagram_text_scale) +
...
checklist %>%
  kable(caption = "Sample AM Inspection Checklist") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#E74C3C", color = "white") %>%
  column_spec(1, bold = TRUE, width = "3em")
...
ggplot() +
  ...
  annotate("text", x = 1.15, y = 2.5, label = "REACTIVE", fontface = "bold", color = "white", size = 5 * diagram_text_scale) +
  annotate("text", x = 1.15, y = 1.5, label = "Breakdown\nMaintenance\n\nFix when broken",
           color = "white", size = 4 * diagram_text_scale, lineheight = 0.9) +
  # Preventive
  annotate("rect", xmin = 2.6, xmax = 4.9, ymin = 0, ymax = 3, fill = "#F39C12", alpha = 0.8) +
  annotate("text", x = 3.75, y = 2.5, label = "PREVENTIVE", fontface = "bold", color = "white", size = 5 * diagram_text_scale) +
  annotate("text", x = 3.75, y = 1.5, label = "Time-Based\nMaintenance\n\nScheduled intervals",
           color = "white", size = 4 * diagram_text_scale, lineheight = 0.9) +
  # Predictive
  annotate("rect", xmin = 5.2, xmax = 7.5, ymin = 0, ymax = 3, fill = "#3498DB", alpha = 0.8) +
  annotate("text", x = 6.35, y = 2.5, label = "PREDICTIVE", fontface = "bold", color = "white", size = 5 * diagram_text_scale) +
  annotate("text", x = 6.35, y = 1.5, label = "Condition-Based\nMaintenance\n\nMonitor & predict",
           color = "white", size = 4 * diagram_text_scale, lineheight = 0.9) +
  # Proactive
  annotate("rect", xmin = 7.8, xmax = 10.1, ymin = 0, ymax = 3, fill = "#27AE60", alpha = 0.8) +
  annotate("text", x = 8.95, y = 2.5, label = "PROACTIVE", fontface = "bold", color = "white", size = 5 * diagram_text_scale) +
...
maint_compare %>%
  kable(caption = "Maintenance Strategy Comparison") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#9B59B6", color = "white") %>%
  column_spec(1, bold = TRUE, width = "10em")
...
pdm_tech %>%
  kable(caption = "Predictive Maintenance Technologies") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
...
ggplot(pf_data, aes(x = x, y = y)) +
  ...
  annotate("text", x = 1, y = 45, label = "Design for\nReliability", fontface = "bold",
           color = "#1E8449", size = 3.5 * diagram_text_scale, lineheight = 0.9) +
  annotate("text", x = 3.5, y = 35, label = "Condition Based\nMaintenance", fontface = "bold",
           color = "#B7950B", size = 3.5 * diagram_text_scale, lineheight = 0.9) +
  annotate("text", x = 6.2, y = 25, label = "Planned\nPreventative\nMaintenance", fontface = "bold",
           color = "#CA6F1E", size = 3.5 * diagram_text_scale, lineheight = 0.85) +
  annotate("text", x = 8.8, y = 18, label = "Reactive /\nRun-To-Failure", fontface = "bold",
           color = "#922B21", size = 3.5 * diagram_text_scale, lineheight = 0.9) +
  # P point
  annotate("point", x = p_x, y = pf_data$y[which.min(abs(pf_data$x - p_x))], size = 4, color = "#2C3E50") +
  annotate("text", x = p_x, y = 100, label = "P", fontface = "bold", color = "#2C3E50", size = 6 * diagram_text_scale) +
  annotate("text", x = p_x, y = 96, label = "oint of failure\ndetection", hjust = 0,
           color = "#2C3E50", size = 3 * diagram_text_scale, lineheight = 0.9) +
  # F point
  annotate("point", x = f_x, y = pf_data$y[which.min(abs(pf_data$x - f_x))], size = 4, color = "#C0392B") +
  annotate("text", x = f_x, y = 100, label = "F", fontface = "bold", color = "#C0392B", size = 6 * diagram_text_scale) +
  annotate("text", x = f_x, y = 96, label = "unctional failure", hjust = 0,
           color = "#C0392B", size = 3 * diagram_text_scale, lineheight = 0.9) +
  # Detection methods along curve (angled text)
  annotate("text", x = 0.3, y = 100, label = "Installation", angle = 55, hjust = 0,
           color = "#2C3E50", size = 3 * diagram_text_scale, fontface = "italic") +
  ...
  annotate("text", x = 9.7, y = 35, label = "Failed!", fontface = "bold",
           color = "#C0392B", size = 6 * diagram_text_scale) +
  ...
  annotate("text", x = (p_x + f_x)/2, y = -10, label = "P to F Interval", fontface = "bold",
           color = "#2C3E50", size = 4 * diagram_text_scale) +
  # Axis settings
  ...
  theme(
    ...
    axis.title = element_text(face = "bold", size = 11 * diagram_text_scale),
...
ggplot() +
  ...
  annotate("text", x = 0.9, y = 2.1, label = "1. SELECT", fontface = "bold", color = "white", size = 3.5 * diagram_text_scale) +
  annotate("text", x = 0.9, y = 1.5, label = "Identify\nbiggest loss", color = "white", size = 3.5 * diagram_text_scale, lineheight = 0.9) +

  annotate("rect", xmin = 2, xmax = 3.8, ymin = 1, ymax = 2.5, fill = "#27AE60", color = "black") +
  annotate("text", x = 2.9, y = 2.1, label = "2. ANALYZE", fontface = "bold", color = "white", size = 3.5 * diagram_text_scale) +
  annotate("text", x = 2.9, y = 1.5, label = "Root cause\nanalysis", color = "white", size = 3.5 * diagram_text_scale, lineheight = 0.9) +

  annotate("rect", xmin = 4, xmax = 5.8, ymin = 1, ymax = 2.5, fill = "#F39C12", color = "black") +
  annotate("text", x = 4.9, y = 2.1, label = "3. DEVELOP", fontface = "bold", color = "white", size = 3.5 * diagram_text_scale) +
  annotate("text", x = 4.9, y = 1.5, label = "Counter-\nmeasures", color = "white", size = 3.5 * diagram_text_scale, lineheight = 0.9) +

  annotate("rect", xmin = 6, xmax = 7.8, ymin = 1, ymax = 2.5, fill = "#E74C3C", color = "black") +
  annotate("text", x = 6.9, y = 2.1, label = "4. IMPLEMENT", fontface = "bold", color = "white", size = 3.5 * diagram_text_scale) +
  annotate("text", x = 6.9, y = 1.5, label = "Execute\nplan", color = "white", size = 3.5 * diagram_text_scale, lineheight = 0.9) +

  annotate("rect", xmin = 8, xmax = 9.8, ymin = 1, ymax = 2.5, fill = "#9B59B6", color = "black") +
  annotate("text", x = 8.9, y = 2.1, label = "5. SUSTAIN", fontface = "bold", color = "white", size = 3.5 * diagram_text_scale) +
  annotate("text", x = 8.9, y = 1.5, label = "Standardize\n& share", color = "white", size = 3.5 * diagram_text_scale, lineheight = 0.9) +
...
ggplot() +
  ...
  annotate("text", x = 1.5, y = 2.1, label = "Step 1", fontface = "bold", color = "white", size = 4 * diagram_text_scale) +
  annotate("text", x = 1.5, y = 1.5, label = "Separate\nInternal & External", color = "white", size = 3 * diagram_text_scale, lineheight = 0.9) +

  annotate("rect", xmin = 3, xmax = 5, ymin = 1, ymax = 2.5, fill = "#27AE60", color = "black") +
  annotate("text", x = 4, y = 2.1, label = "Step 2", fontface = "bold", color = "white", size = 4 * diagram_text_scale) +
  annotate("text", x = 4, y = 1.5, label = "Convert\nInternal to External", color = "white", size = 3 * diagram_text_scale, lineheight = 0.9) +

  annotate("rect", xmin = 5.5, xmax = 7.5, ymin = 1, ymax = 2.5, fill = "#F39C12", color = "black") +
  annotate("text", x = 6.5, y = 2.1, label = "Step 3", fontface = "bold", color = "white", size = 4 * diagram_text_scale) +
  annotate("text", x = 6.5, y = 1.5, label = "Streamline\nAll Elements", color = "white", size = 3 * diagram_text_scale, lineheight = 0.9) +
...
tools %>%
  kable(caption = "Tools for Loss Elimination") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#27AE60", color = "white") %>%
  column_spec(1, bold = TRUE, width = "12em")
...
impl_steps %>%
  kable(caption = "12 Steps of TPM Implementation") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#16A085", color = "white") %>%
...
success %>%
  kable(caption = "TPM Success Factors") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
  row_spec(0, bold = TRUE, background = "#27AE60", color = "white") %>%
...
ggplot(case_data, aes(x = component, y = value, fill = period)) +
  ...
  geom_text(aes(label = paste0(value, "%")), position = position_dodge(width = 0.7),
            vjust = -0.5, size = 3.5 * diagram_text_scale) +
...
summary_data %>%
  kable(caption = "TPM Key Concepts Summary") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                full_width = knitr::is_html_output(), position = "center") %>%
