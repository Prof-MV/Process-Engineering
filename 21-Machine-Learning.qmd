...
The companion lab handout (@sec-chap-ml-lab) provides the step-by-step exercises, Python code, and deliverable instructions for each week.
...
|  | By the end of this week, you will be able to… | Assessment |
|---|---|---|
| 4.1 | Implement per-engine rolling-window features in Python using `groupby().transform()` | Lab Week 4 Task 1 |
